 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp10 = (fConst1 * ((((0.0296654552f * fTemp7) + (0.0146881239f * fTemp8)) + (0.0385625586f * fTemp9)) - (fConst3 * fRec1[1])));
			...
			fVec0[(IOTA & 1023)] = (fRec2 + (0.0173517056f * fTemp11));
			output0[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec0[((IOTA - iConst4) & 1023)])));
			float fTemp12 = (fConst1 * ((((0.00816663075f * fTemp7) + (0.0080504287f * fTemp8)) + (0.0339480191f * fTemp9)) - (fConst3 * fRec10[1])));
			fRec12[0] = (fRec12[1] + fTemp12);
			fRec10[0] = fRec12[0];
			float fRec11 = fTemp12;
			fVec1[(IOTA & 1023)] = (fRec11 + (0.0121423434f * fTemp11));
			output1[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec1[((IOTA - iConst4) & 1023)])));
			float fTemp13 = (fConst1 * ((((0.0147326542f * fTemp8) + (0.0485469438f * fTemp9)) - (0.00653544394f * fTemp7)) - (fConst3 * fRec13[1])));
			fRec15[0] = (fRec15[1] + fTemp13);
			fRec13[0] = fRec15[0];
			float fRec14 = fTemp13;
			fVec2[(IOTA & 1023)] = (fRec14 + (0.0174661018f * fTemp11));
			output2[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec2[((IOTA - iConst4) & 1023)])));
			float fTemp14 = (fConst1 * ((((0.00806470029f * fTemp8) + (0.0297580194f * fTemp9)) - (0.0184110664f * fTemp7)) - (fConst3 * fRec16[1])));
			fRec18[0] = (fRec18[1] + fTemp14);
			fRec16[0] = fRec18[0];
			float fRec17 = fTemp14;
			fVec3[(IOTA & 1023)] = (fRec17 + (0.0121692494f * fTemp11));
			output3[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec3[((IOTA - iConst4) & 1023)])));
			float fTemp15 = (fConst1 * ((((0.0150436228f * fTemp8) + (0.0297978744f * fTemp9)) - (0.0399229303f * fTemp7)) - (fConst3 * fRec19[1])));
			fRec21[0] = (fRec21[1] + fTemp15);
			fRec19[0] = fRec21[0];
			float fRec20 = fTemp15;
			fVec4[(IOTA & 1023)] = (fRec20 + (0.0177769475f * fTemp11));
			output4[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec4[((IOTA - iConst4) & 1023)])));
			float fTemp16 = (fConst1 * ((((0.00813698862f * fTemp8) + (0.0076172282f * fTemp9)) - (0.0345108211f * fTemp7)) - (fConst3 * fRec22[1])));
			fRec24[0] = (fRec24[1] + fTemp16);
			fRec22[0] = fRec24[0];
			float fRec23 = fTemp16;
			fVec5[(IOTA & 1023)] = (fRec23 + (0.0122919185f * fTemp11));
			output5[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec5[((IOTA - iConst4) & 1023)])));
			float fTemp17 = (fConst1 * (((0.0152102625f * fTemp8) - ((0.049679745f * fTemp7) + (0.00827172492f * fTemp9))) - (fConst3 * fRec25[1])));
			fRec27[0] = (fRec27[1] + fTemp17);
			fRec25[0] = fRec27[0];
			float fRec26 = fTemp17;
			fVec6[(IOTA & 1023)] = (fRec26 + (0.0179759711f * fTemp11));
			output6[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec6[((IOTA - iConst4) & 1023)])));
			float fTemp18 = (fConst1 * (((0.0082610324f * fTemp8) - ((0.0297759175f * fTemp7) + (0.0199645739f * fTemp9))) - (fConst3 * fRec28[1])));
			fRec30[0] = (fRec30[1] + fTemp18);
			fRec28[0] = fRec30[0];
			float fRec29 = fTemp18;
			fVec7[(IOTA & 1023)] = (fRec29 + (0.0124723194f * fTemp11));
			output7[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec7[((IOTA - iConst4) & 1023)])));
			float fTemp19 = (fConst1 * (((0.0141814519f * fTemp8) - ((0.0271127317f * fTemp7) + (0.0388887972f * fTemp9))) - (fConst3 * fRec31[1])));
			fRec33[0] = (fRec33[1] + fTemp19);
			fRec31[0] = fRec33[0];
			float fRec32 = fTemp19;
			fVec8[(IOTA & 1023)] = (fRec32 + (0.0168837607f * fTemp11));
			output8[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec8[((IOTA - iConst4) & 1023)])));
			float fTemp20 = (fConst1 * (((0.0139324786f * fTemp8) - ((0.00657636859f * fTemp7) + (0.0462513417f * fTemp9))) - (fConst3 * fRec34[1])));
			fRec36[0] = (fRec36[1] + fTemp20);
			fRec34[0] = fRec36[0];
			float fRec35 = fTemp20;
			fVec9[(IOTA & 1023)] = (fRec35 + (0.0166288801f * fTemp11));
			output9[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec9[((IOTA - iConst4) & 1023)])));
			float fTemp21 = (fConst1 * ((((0.00778907491f * fTemp7) + (0.0080658691f * fTemp8)) - (0.0343690775f * fTemp9)) - (fConst3 * fRec37[1])));
			fRec39[0] = (fRec39[1] + fTemp21);
			fRec37[0] = fRec39[0];
			float fRec38 = fTemp21;
			fVec10[(IOTA & 1023)] = (fRec38 + (0.0122519135f * fTemp11));
			output10[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec10[((IOTA - iConst4) & 1023)])));
			float fTemp22 = (fConst1 * ((((0.028083669f * fTemp7) + (0.0142656397f * fTemp8)) - (0.0382314026f * fTemp9)) - (fConst3 * fRec40[1])));
			fRec42[0] = (fRec42[1] + fTemp22);
			fRec40[0] = fRec42[0];
			float fRec41 = fTemp22;
			fVec11[(IOTA & 1023)] = (fRec41 + (0.0168990009f * fTemp11));
			output11[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec11[((IOTA - iConst4) & 1023)])));
			float fTemp23 = (fConst1 * ((((0.0278907772f * fTemp7) + (0.00765112508f * fTemp8)) - (0.0181327537f * fTemp9)) - (fConst3 * fRec43[1])));
			fRec45[0] = (fRec45[1] + fTemp23);
			fRec43[0] = fRec45[0];
			float fRec44 = fTemp23;
			fVec12[(IOTA & 1023)] = (fRec44 + (0.0115571907f * fTemp11));
			output12[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec12[((IOTA - iConst4) & 1023)])));
			float fTemp24 = (fConst1 * ((((0.0472527407f * fTemp7) + (0.0146665508f * fTemp8)) - (0.00807858817f * fTemp9)) - (fConst3 * fRec46[1])));
			fRec48[0] = (fRec48[1] + fTemp24);
			fRec46[0] = fRec48[0];
			float fRec47 = fTemp24;
			fVec13[(IOTA & 1023)] = (fRec47 + (0.0171159822f * fTemp11));
			output13[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec13[((IOTA - iConst4) & 1023)])));
			float fTemp25 = (fConst1 * ((((0.034308698f * fTemp7) + (0.00801151432f * fTemp8)) + (0.00665730657f * fTemp9)) - (fConst3 * fRec49[1])));
			fRec51[0] = (fRec51[1] + fTemp25);
			fRec49[0] = fRec51[0];
			float fRec50 = fTemp25;
			fVec14[(IOTA & 1023)] = (fRec50 + (0.0121517424f * fTemp11));
			output14[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec14[((IOTA - iConst4) & 1023)])));
			float fTemp26 = (fConst1 * ((((0.0295908526f * fTemp7) + (0.00805393979f * fTemp8)) + (0.0180607811f * fTemp9)) - (fConst3 * fRec52[1])));
			fRec54[0] = (fRec54[1] + fTemp26);
			fRec52[0] = fRec54[0];
			float fRec53 = fTemp26;
			fVec15[(IOTA & 1023)] = (fRec53 + (0.0120597398f * fTemp11));
			output15[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec15[((IOTA - iConst4) & 1023)])));
			float fTemp27 = (fConst5 * ((((0.0258369539f * fTemp7) + (0.0730907619f * fTemp8)) + (0.0790967792f * fTemp9)) - (fConst6 * fRec55[1])));
			fRec57[0] = (fRec57[1] + fTemp27);
			fRec55[0] = fRec57[0];
			float fRec56 = fTemp27;
			fVec16[(IOTA & 511)] = (fRec56 + (0.0389358997f * fTemp11));
			output16[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec16[((IOTA - iConst7) & 511)])));
			float fTemp28 = (fConst5 * ((((0.0562963411f * fTemp8) + (0.0654787123f * fTemp9)) - (0.0324570462f * fTemp7)) - (fConst6 * fRec58[1])));
			fRec60[0] = (fRec60[1] + fTemp28);
			fRec58[0] = fRec60[0];
			float fRec59 = fTemp28;
			fVec17[(IOTA & 511)] = (fRec59 + (0.0321440324f * fTemp11));
			output17[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec17[((IOTA - iConst7) & 511)])));
			float fTemp29 = (fConst5 * ((((0.0741337016f * fTemp8) + (0.0243202727f * fTemp9)) - (0.0808136836f * fTemp7)) - (fConst6 * fRec61[1])));
			fRec63[0] = (fRec63[1] + fTemp29);
			fRec61[0] = fRec63[0];
			float fRec62 = fTemp29;
			fVec18[(IOTA & 511)] = (fRec62 + (0.0395166576f * fTemp11));
			output18[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec18[((IOTA - iConst7) & 511)])));
			float fTemp30 = (fConst5 * (((0.0554719977f * fTemp8) - ((0.0641313195f * fTemp7) + (0.0336948335f * fTemp9))) - (fConst6 * fRec64[1])));
			fRec66[0] = (fRec66[1] + fTemp30);
			fRec64[0] = fRec66[0];
			float fRec65 = fTemp30;
			fVec19[(IOTA & 511)] = (fRec65 + (0.0317779481f * fTemp11));
			output19[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec19[((IOTA - iConst7) & 511)])));
			float fTemp31 = (fConst5 * (((0.0661523789f * fTemp8) - ((0.0233769547f * fTemp7) + (0.0679899305f * fTemp9))) - (fConst6 * fRec67[1])));
			fRec69[0] = (fRec69[1] + fTemp31);
			fRec67[0] = fRec69[0];
			float fRec68 = fTemp31;
			fVec20[(IOTA & 511)] = (fRec68 + (0.0341328457f * fTemp11));
			output20[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec20[((IOTA - iConst7) & 511)])));
			float fTemp32 = (fConst5 * ((((0.0244521499f * fTemp7) + (0.0535257049f * fTemp8)) - (0.0656843856f * fTemp9)) - (fConst6 * fRec70[1])));
			fRec72[0] = (fRec72[1] + fTemp32);
			fRec70[0] = fRec72[0];
			float fRec71 = fTemp32;
			fVec21[(IOTA & 511)] = (fRec71 + (0.0306867547f * fTemp11));
			output21[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec21[((IOTA - iConst7) & 511)])));
			float fTemp33 = (fConst5 * ((((0.0639034882f * fTemp7) + (0.0554443188f * fTemp8)) - (0.032747671f * fTemp9)) - (fConst6 * fRec73[1])));
			fRec75[0] = (fRec75[1] + fTemp33);
			fRec73[0] = fRec75[0];
			float fRec74 = fTemp33;
			fVec22[(IOTA & 511)] = (fRec74 + (0.0315846391f * fTemp11));
			output22[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec22[((IOTA - iConst7) & 511)])));
			float fTemp34 = (fConst5 * ((((0.0863064751f * fTemp7) + (0.0777221099f * fTemp8)) + (0.0305791534f * fTemp9)) - (fConst6 * fRec76[1])));
			fRec78[0] = (fRec78[1] + fTemp34);
			fRec76[0] = fRec78[0];
			float fRec77 = fTemp34;
			fVec23[(IOTA & 511)] = (fRec77 + (0.0424795263f * fTemp11));
			output23[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec23[((IOTA - iConst7) & 511)])));
			float fTemp35 = (fConst8 * ((((0.0220263973f * fTemp7) + (0.0669407099f * fTemp8)) + (0.0219154879f * fTemp9)) - (fConst9 * fRec79[1])));
			fRec81[0] = (fRec81[1] + fTemp35);
			fRec79[0] = fRec81[0];
			float fRec80 = fTemp35;
			fVec24[(IOTA & 255)] = (fRec80 + (0.0254848376f * fTemp11));
			output24[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec24[((IOTA - iConst10) & 255)])));
			float fTemp36 = (fConst8 * ((((0.0882500932f * fTemp8) + (0.0363471471f * fTemp9)) - (0.0221166983f * fTemp7)) - (fConst9 * fRec82[1])));
			fRec84[0] = (fRec84[1] + fTemp36);
			fRec82[0] = fRec84[0];
			float fRec83 = fTemp36;
			fVec25[(IOTA & 255)] = (fRec83 + (0.0342672393f * fTemp11));
			output25[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec25[((IOTA - iConst10) & 255)])));
			float fTemp37 = (fConst8 * (((0.0877469257f * fTemp8) - ((0.0360210091f * fTemp7) + (0.0223415233f * fTemp9))) - (fConst9 * fRec85[1])));
			fRec87[0] = (fRec87[1] + fTemp37);
			fRec85[0] = fRec87[0];
			float fRec86 = fTemp37;
			fVec26[(IOTA & 255)] = (fRec86 + (0.0340686888f * fTemp11));
			output26[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec26[((IOTA - iConst10) & 255)])));
			float fTemp38 = (fConst8 * ((((0.0360226892f * fTemp7) + (0.107946441f * fTemp8)) - (0.0360071734f * fTemp9)) - (fConst9 * fRec88[1])));
			fRec90[0] = (fRec90[1] + fTemp38);
			fRec88[0] = fRec90[0];
			float fRec89 = fTemp38;
			fVec27[(IOTA & 255)] = (fRec89 + (0.0424027964f * fTemp11));
			output27[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec27[((IOTA - iConst10) & 255)])));
			float fTemp39 = (fConst11 * ((((1.96569999e-06f * fTemp7) + (0.030448107f * fTemp8)) - (8.51769983e-06f * fTemp9)) - (fConst12 * fRec91[1])));
			fRec93[0] = (fRec93[1] + fTemp39);
			fRec91[0] = fRec93[0];
			float fRec92 = fTemp39;
			output28[i] = FAUSTFLOAT((fRec0[0] * (fRec92 + (0.0102900397f * fTemp11))));
			float fTemp40 = (fConst1 * ((((0.035999883f * fTemp7) + (0.0802532509f * fTemp9)) - (0.0359963588f * fTemp8)) - (fConst3 * fRec94[1])));
			fRec96[0] = (fRec96[1] + fTemp40);
			fRec94[0] = fRec96[0];
			float fRec95 = fTemp40;
			fVec28[(IOTA & 1023)] = (fRec95 + (0.0339854807f * fTemp11));
			output29[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec28[((IOTA - iConst4) & 1023)])));
			float fTemp41 = (fConst1 * ((((0.00219289516f * fTemp7) + (0.0883968771f * fTemp9)) - (0.0357965156f * fTemp8)) - (fConst3 * fRec97[1])));
			fRec99[0] = (fRec99[1] + fTemp41);
			fRec97[0] = fRec99[0];
			float fRec98 = fTemp41;
			fVec29[(IOTA & 1023)] = (fRec98 + (0.0341288708f * fTemp11));
			output30[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec29[((IOTA - iConst4) & 1023)])));
			float fTemp42 = (fConst1 * (((0.0819987282f * fTemp9) - ((0.0318913348f * fTemp7) + (0.0359743834f * fTemp8))) - (fConst3 * fRec100[1])));
			fRec102[0] = (fRec102[1] + fTemp42);
			fRec100[0] = fRec102[0];
			float fRec101 = fTemp42;
			fVec30[(IOTA & 1023)] = (fRec101 + (0.0339966118f * fTemp11));
			output31[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec30[((IOTA - iConst4) & 1023)])));
			float fTemp43 = (fConst1 * (((0.0639806613f * fTemp9) - ((0.0619228333f * fTemp7) + (0.0360982791f * fTemp8))) - (fConst3 * fRec103[1])));
			fRec105[0] = (fRec105[1] + fTemp43);
			fRec103[0] = fRec105[0];
			float fRec104 = fTemp43;
			fVec31[(IOTA & 1023)] = (fRec104 + (0.0343768448f * fTemp11));
			output32[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec31[((IOTA - iConst4) & 1023)])));
			float fTemp44 = (fConst1 * (((0.0349279977f * fTemp9) - ((0.0819450319f * fTemp7) + (0.0363389291f * fTemp8))) - (fConst3 * fRec106[1])));
			fRec108[0] = (fRec108[1] + fTemp44);
			fRec106[0] = fRec108[0];
			float fRec107 = fTemp44;
			fVec32[(IOTA & 1023)] = (fRec107 + (0.034416955f * fTemp11));
			output33[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec32[((IOTA - iConst4) & 1023)])));
			float fTemp45 = (fConst1 * (((1.68336992e-05f * fTemp9) - ((0.089838244f * fTemp7) + (0.036576286f * fTemp8))) - (fConst3 * fRec109[1])));
			fRec111[0] = (fRec111[1] + fTemp45);
			fRec109[0] = fRec111[0];
			float fRec110 = fTemp45;
			fVec33[(IOTA & 1023)] = (fRec110 + (0.0347152688f * fTemp11));
			output34[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec33[((IOTA - iConst4) & 1023)])));
			float fTemp46 = (fConst1 * ((0.0f - (((0.0831632838f * fTemp7) + (0.0367748067f * fTemp8)) + (0.0355247334f * fTemp9))) - (fConst3 * fRec112[1])));
			fRec114[0] = (fRec114[1] + fTemp46);
			fRec112[0] = fRec114[0];
			float fRec113 = fTemp46;
			fVec34[(IOTA & 1023)] = (fRec113 + (0.0349377953f * fTemp11));
			output35[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec34[((IOTA - iConst4) & 1023)])));
			float fTemp47 = (fConst1 * ((0.0f - (((0.061302159f * fTemp7) + (0.0359172188f * fTemp8)) + (0.0636048689f * fTemp9))) - (fConst3 * fRec115[1])));
			fRec117[0] = (fRec117[1] + fTemp47);
			fRec115[0] = fRec117[0];
			float fRec116 = fTemp47;
			fVec35[(IOTA & 1023)] = (fRec116 + (0.0341170803f * fTemp11));
			output36[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec35[((IOTA - iConst4) & 1023)])));
			float fTemp48 = (fConst1 * ((0.0f - (((0.0312354527f * fTemp7) + (0.0343445688f * fTemp8)) + (0.0783443823f * fTemp9))) - (fConst3 * fRec118[1])));
			fRec120[0] = (fRec120[1] + fTemp48);
			fRec118[0] = fRec120[0];
			float fRec119 = fTemp48;
			fVec36[(IOTA & 1023)] = (fRec119 + (0.0325375088f * fTemp11));
			output37[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec36[((IOTA - iConst4) & 1023)])));
			float fTemp49 = (fConst1 * (((0.00110292342f * fTemp7) - ((0.0356718414f * fTemp8) + (0.0878395364f * fTemp9))) - (fConst3 * fRec121[1])));
			fRec123[0] = (fRec123[1] + fTemp49);
			fRec121[0] = fRec123[0];
			float fRec122 = fTemp49;
			fVec37[(IOTA & 1023)] = (fRec122 + (0.0339145884f * fTemp11));
			output38[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec37[((IOTA - iConst4) & 1023)])));
			float fTemp50 = (fConst1 * (((0.0345684774f * fTemp7) - ((0.0361376181f * fTemp8) + (0.0815256909f * fTemp9))) - (fConst3 * fRec124[1])));
			fRec126[0] = (fRec126[1] + fTemp50);
			fRec124[0] = fRec126[0];
			float fRec125 = fTemp50;
			fVec38[(IOTA & 1023)] = (fRec125 + (0.0342118219f * fTemp11));
			output39[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec38[((IOTA - iConst4) & 1023)])));
			float fTemp51 = (fConst1 * (((0.0602403842f * fTemp7) - ((0.0343579128f * fTemp8) + (0.0593765974f * fTemp9))) - (fConst3 * fRec127[1])));
			fRec129[0] = (fRec129[1] + fTemp51);
			fRec127[0] = fRec129[0];
			float fRec128 = fTemp51;
			fVec39[(IOTA & 1023)] = (fRec128 + (0.0326253697f * fTemp11));
			output40[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec39[((IOTA - iConst4) & 1023)])));
			float fTemp52 = (fConst1 * (((0.0759127513f * fTemp7) - ((0.0335862301f * fTemp8) + (0.0325001478f * fTemp9))) - (fConst3 * fRec130[1])));
			fRec132[0] = (fRec132[1] + fTemp52);
			fRec130[0] = fRec132[0];
			float fRec131 = fTemp52;
			fVec40[(IOTA & 1023)] = (fRec131 + (0.0318444856f * fTemp11));
			output41[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec40[((IOTA - iConst4) & 1023)])));
			float fTemp53 = (fConst1 * (((0.0863605216f * fTemp7) - ((0.0350535177f * fTemp8) + (0.00169773924f * fTemp9))) - (fConst3 * fRec133[1])));
			fRec135[0] = (fRec135[1] + fTemp53);
			fRec133[0] = fRec135[0];
			float fRec134 = fTemp53;
			fVec41[(IOTA & 1023)] = (fRec134 + (0.0333273932f * fTemp11));
			output42[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec41[((IOTA - iConst4) & 1023)])));
			float fTemp54 = (fConst1 * ((((0.0818483755f * fTemp7) + (0.0311322436f * fTemp9)) - (0.0357059762f * fTemp8)) - (fConst3 * fRec136[1])));
			fRec138[0] = (fRec138[1] + fTemp54);
			fRec136[0] = fRec138[0];
			float fRec137 = fTemp54;
			fVec42[(IOTA & 1023)] = (fRec137 + (0.0338216871f * fTemp11));
			output43[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec42[((IOTA - iConst4) & 1023)])));
			float fTemp55 = (fConst1 * ((((0.0628859028f * fTemp7) + (0.0597497374f * fTemp9)) - (0.0351643153f * fTemp8)) - (fConst3 * fRec139[1])));
			fRec141[0] = (fRec141[1] + fTemp55);
			fRec139[0] = fRec141[0];
			float fRec140 = fTemp55;
			fVec43[(IOTA & 1023)] = (fRec140 + (0.0334724449f * fTemp11));
