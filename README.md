...
Scroll down to [Klangkupolen, Lilla Salen](#org98bce62) for specifics
...
All decoders use ACN channel order (see [Component order](#orgd9c9b9a)) and SN3D normalization (see [Normalisation](#orgce814e9)) and are dual-band, max-rE/rV.
...
<table id="orgc36416c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
-   29 speakers
    ...
    A setup file for the current speaker arrangments in Lilla Salen (29 speakers) according to [Speaker positions](#org2689de4) for use with the Ircam spat package. 
...
-   45 speakers
    ...
    A setup file for the current speaker arrangments in Lilla Salen (45 speakers) according to [Speaker positions](#org2689de4) for use with the Ircam spat package. 
...
-   29 speakers
    ...
    A setup file for the current speaker arrangments in Lilla Salen (29 speakers) according to [Speaker positions](#org2689de4) for use with the Ircam panoramix package. 
