...
Scroll down to [Klangkupolen, Lilla Salen](#orgf55b8ad) for specifics
...
All decoders use ACN channel order (see [Component order](#org9ebabbe)) and SN3D normalization (see [Normalisation](#org3781240)) and are dual-band, max-rE/rV.
...
<table id="orgb73cc8a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
-   29 speaker
    ...
    A setup file for the current speaker arrangments in Lilla Salen (29 speakers) according to [Speaker positions](#org6d994b7) for use with the Ircam spat package. 
    
    The file generated by the script above to be used for a `spat.viewer @numspeakers 29 @showlistener 1 @viewpoint top @width 1200 @height 600`:
...
-   45 speakers
    ...
    A setup file for the current speaker arrangments in Lilla Salen (45 speakers) according to [Speaker positions](#org6d994b7) for use with the Ircam spat package. 
