...
Scroll down to [Klangkupolen, Lilla Salen](#org12b5e7c) for specifics
...
All decoders use ACN channel order (see [Component order](#org3ba22cb)) and SN3D normalization (see [Normalisation](#org5f6d462)) and are dual-band, max-rE/rV.
...
<table id="orga29aec7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
-   29 speakers
    ...
    A setup file for the current speaker arrangments in Lilla Salen (29 speakers) according to [Speaker positions](#org5718694) for use with the Ircam spat package. 
...
-   45 speakers
    ...
    A setup file for the current speaker arrangments in Lilla Salen (45 speakers) according to [Speaker positions](#org5718694) for use with the Ircam spat package. 
...
-   29 speakers
    ...
    A setup file for the current speaker arrangments in Lilla Salen (29 speakers) according to [Speaker positions](#org5718694) for use with the Ircam panoramix package. 
