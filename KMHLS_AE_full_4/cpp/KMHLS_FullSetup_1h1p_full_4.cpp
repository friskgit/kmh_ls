 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp7 = (((fTemp1 * (fRec5[2] + (fRec5[0] + (2.0f * fRec5[1])))) / fTemp5) + (2.73861289f * (fRec6[0] * (0.0f - ((fTemp6 * fRec5[1]) + ((fRec5[0] + fRec5[2]) / fTemp4))))));
			fRec7[0] = (float(input3[i]) - (((fTemp2 * fRec7[2]) + (2.0f * (fTemp3 * fRec7[1]))) / fTemp4));
			float fTemp8 = (((fTemp1 * (fRec7[2] + (fRec7[0] + (2.0f * fRec7[1])))) / fTemp5) + (2.73861289f * (fRec6[0] * (0.0f - ((fTemp6 * fRec7[1]) + ((fRec7[0] + fRec7[2]) / fTemp4))))));
			fRec8[0] = (float(input2[i]) - (((fTemp2 * fRec8[2]) + (2.0f * (fTemp3 * fRec8[1]))) / fTemp4));
			float fTemp9 = (((fTemp1 * (fRec8[2] + (fRec8[0] + (2.0f * fRec8[1])))) / fTemp5) + (2.73861289f * (fRec6[0] * (0.0f - ((fTemp6 * fRec8[1]) + ((fRec8[0] + fRec8[2]) / fTemp4))))));
			float fTemp10 = (fConst1 * ((((0.0322413482f * fTemp7) + (0.0470807776f * fTemp8)) - (0.00292664277f * fTemp9)) - (fConst3 * fRec1[1])));
			fRec3[0] = (fRec3[1] + fTemp10);
			fRec1[0] = fRec3[0];
			float fRec2 = fTemp10;
			fRec9[0] = (float(input0[i]) - (((fRec9[2] * fTemp2) + (2.0f * (fRec9[1] * fTemp3))) / fTemp4));
			float fTemp11 = (((fTemp1 * (fRec9[2] + (fRec9[0] + (2.0f * fRec9[1])))) / fTemp5) + (4.74341631f * (fRec6[0] * (0.0f - ((fRec9[1] * fTemp6) + ((fRec9[0] + fRec9[2]) / fTemp4))))));
			fVec0[(IOTA & 1023)] = (fRec2 + (0.032652542f * fTemp11));
			output0[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec0[((IOTA - iConst4) & 1023)])));
			float fTemp12 = (fConst1 * ((((0.0129417377f * fTemp7) + (0.0556191392f * fTemp8)) - (0.00308230403f * fTemp9)) - (fConst3 * fRec10[1])));
			fRec12[0] = (fRec12[1] + fTemp12);
			fRec10[0] = fRec12[0];
			float fRec11 = fTemp12;
			fVec1[(IOTA & 1023)] = (fRec11 + (0.0328499936f * fTemp11));
			output1[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec1[((IOTA - iConst4) & 1023)])));
			float fTemp13 = (fConst1 * (((0.0561905913f * fTemp8) - ((0.0106597142f * fTemp7) + (0.00328142708f * fTemp9))) - (fConst3 * fRec13[1])));
			fRec15[0] = (fRec15[1] + fTemp13);
			fRec13[0] = fRec15[0];
			float fRec14 = fTemp13;
			fVec2[(IOTA & 1023)] = (fRec14 + (0.0330463983f * fTemp11));
			output2[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec2[((IOTA - iConst4) & 1023)])));
			float fTemp14 = (fConst1 * (((0.0484021418f * fTemp8) - ((0.0307123829f * fTemp7) + (0.00345795741f * fTemp9))) - (fConst3 * fRec16[1])));
			fRec18[0] = (fRec18[1] + fTemp14);
			fRec16[0] = fRec18[0];
			float fRec17 = fTemp14;
			fVec3[(IOTA & 1023)] = (fRec17 + (0.0331754982f * fTemp11));
			output3[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec3[((IOTA - iConst4) & 1023)])));
			float fTemp15 = (fConst1 * (((0.032227207f * fTemp8) - ((0.0475966334f * fTemp7) + (0.00361513556f * fTemp9))) - (fConst3 * fRec19[1])));
			fRec21[0] = (fRec21[1] + fTemp15);
			fRec19[0] = fRec21[0];
			float fRec20 = fTemp15;
			fVec4[(IOTA & 1023)] = (fRec20 + (0.0332402959f * fTemp11));
			output4[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec4[((IOTA - iConst4) & 1023)])));
			float fTemp16 = (fConst1 * (((0.0118248155f * fTemp8) - ((0.0563391261f * fTemp7) + (0.00370720192f * fTemp9))) - (fConst3 * fRec22[1])));
			fRec24[0] = (fRec24[1] + fTemp16);
			fRec22[0] = fRec24[0];
			float fRec23 = fTemp16;
			fVec5[(IOTA & 1023)] = (fRec23 + (0.0332189426f * fTemp11));
			output5[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec5[((IOTA - iConst4) & 1023)])));
			float fTemp17 = (fConst1 * ((0.0f - (((0.0564298816f * fTemp7) + (0.00372835458f * fTemp9)) + (0.0111295376f * fTemp8))) - (fConst3 * fRec25[1])));
			fRec27[0] = (fRec27[1] + fTemp17);
			fRec25[0] = fRec27[0];
			float fRec26 = fTemp17;
			fVec6[(IOTA & 1023)] = (fRec26 + (0.0331148952f * fTemp11));
			output6[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec6[((IOTA - iConst4) & 1023)])));
			float fTemp18 = (fConst1 * ((0.0f - (((0.0473471023f * fTemp7) + (0.00367031433f * fTemp9)) + (0.0322828144f * fTemp8))) - (fConst3 * fRec28[1])));
			fRec30[0] = (fRec30[1] + fTemp18);
			fRec28[0] = fRec30[0];
			float fRec29 = fTemp18;
			fVec7[(IOTA & 1023)] = (fRec29 + (0.0329437479f * fTemp11));
			output7[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec7[((IOTA - iConst4) & 1023)])));
			float fTemp19 = (fConst1 * ((0.0f - (((0.0308162868f * fTemp7) + (0.00354439835f * fTemp9)) + (0.047943905f * fTemp8))) - (fConst3 * fRec31[1])));
			fRec33[0] = (fRec33[1] + fTemp19);
			fRec31[0] = fRec33[0];
			float fRec32 = fTemp19;
			fVec8[(IOTA & 1023)] = (fRec32 + (0.0327365138f * fTemp11));
			output8[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec8[((IOTA - iConst4) & 1023)])));
			float fTemp20 = (fConst1 * ((0.0f - (((0.0111835739f * fTemp7) + (0.00338513078f * fTemp9)) + (0.0555939935f * fTemp8))) - (fConst3 * fRec34[1])));
			fRec36[0] = (fRec36[1] + fTemp20);
			fRec34[0] = fRec36[0];
			float fRec35 = fTemp20;
			fVec9[(IOTA & 1023)] = (fRec35 + (0.032540381f * fTemp11));
			output9[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec9[((IOTA - iConst4) & 1023)])));
			float fTemp21 = (fConst1 * (((0.0116213029f * fTemp7) - ((0.00319197238f * fTemp9) + (0.0552949347f * fTemp8))) - (fConst3 * fRec37[1])));
			fRec39[0] = (fRec39[1] + fTemp21);
			fRec37[0] = fRec39[0];
			float fRec38 = fTemp21;
			fVec10[(IOTA & 1023)] = (fRec38 + (0.0323544927f * fTemp11));
			output10[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec10[((IOTA - iConst4) & 1023)])));
			float fTemp22 = (fConst1 * (((0.0318492912f * fTemp7) - ((0.00301317358f * fTemp9) + (0.0466219373f * fTemp8))) - (fConst3 * fRec40[1])));
			fRec42[0] = (fRec42[1] + fTemp22);
			fRec40[0] = fRec42[0];
			float fRec41 = fTemp22;
			fVec11[(IOTA & 1023)] = (fRec41 + (0.032227993f * fTemp11));
			output11[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec11[((IOTA - iConst4) & 1023)])));
			float fTemp23 = (fConst1 * (((0.0471209995f * fTemp7) - ((0.00287037622f * fTemp9) + (0.0312817916f * fTemp8))) - (fConst3 * fRec43[1])));
			fRec45[0] = (fRec45[1] + fTemp23);
			fRec43[0] = fRec45[0];
			float fRec44 = fTemp23;
			fVec12[(IOTA & 1023)] = (fRec44 + (0.032172624f * fTemp11));
			output12[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec12[((IOTA - iConst4) & 1023)])));
			float fTemp24 = (fConst1 * (((0.0554175302f * fTemp7) - ((0.00278316089f * fTemp9) + (0.0120942472f * fTemp8))) - (fConst3 * fRec46[1])));
			fRec48[0] = (fRec48[1] + fTemp24);
			fRec46[0] = fRec48[0];
			float fRec47 = fTemp24;
			fVec13[(IOTA & 1023)] = (fRec47 + (0.0321920961f * fTemp11));
			output13[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec13[((IOTA - iConst4) & 1023)])));
			float fTemp25 = (fConst1 * ((((0.0559456088f * fTemp7) + (0.0103372475f * fTemp8)) - (0.00275877351f * fTemp9)) - (fConst3 * fRec49[1])));
			fRec51[0] = (fRec51[1] + fTemp25);
			fRec49[0] = fRec51[0];
			float fRec50 = fTemp25;
			fVec14[(IOTA & 1023)] = (fRec50 + (0.0322901644f * fTemp11));
			output14[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec14[((IOTA - iConst4) & 1023)])));
			float fTemp26 = (fConst1 * ((((0.0481316894f * fTemp7) + (0.0305398479f * fTemp8)) - (0.00280692545f * fTemp9)) - (fConst3 * fRec52[1])));
			fRec54[0] = (fRec54[1] + fTemp26);
			fRec52[0] = fRec54[0];
			float fRec53 = fTemp26;
			fVec15[(IOTA & 1023)] = (fRec53 + (0.0324465521f * fTemp11));
			output15[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec15[((IOTA - iConst4) & 1023)])));
			float fTemp27 = (fConst5 * ((((0.0182043593f * fTemp7) + (0.0546670333f * fTemp9)) + (0.044685211f * fTemp8)) - (fConst6 * fRec55[1])));
			fRec57[0] = (fRec57[1] + fTemp27);
			fRec55[0] = fRec57[0];
			float fRec56 = fTemp27;
			fVec16[(IOTA & 511)] = (fRec56 + (0.018741047f * fTemp11));
			output16[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec16[((IOTA - iConst7) & 511)])));
			float fTemp28 = (fConst5 * ((((0.0543532781f * fTemp9) + (0.0444767959f * fTemp8)) - (0.0188678186f * fTemp7)) - (fConst6 * fRec58[1])));
			fRec60[0] = (fRec60[1] + fTemp28);
			fRec58[0] = fRec60[0];
			float fRec59 = fTemp28;
			fVec17[(IOTA & 511)] = (fRec59 + (0.0190445017f * fTemp11));
			output17[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec17[((IOTA - iConst7) & 511)])));
			float fTemp29 = (fConst5 * ((((0.0541063771f * fTemp9) + (0.0174155962f * fTemp8)) - (0.0452164598f * fTemp7)) - (fConst6 * fRec61[1])));
			fRec63[0] = (fRec63[1] + fTemp29);
			fRec61[0] = fRec63[0];
			float fRec62 = fTemp29;
			fVec18[(IOTA & 511)] = (fRec62 + (0.0191373136f * fTemp11));
			output18[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec18[((IOTA - iConst7) & 511)])));
			float fTemp30 = (fConst5 * (((0.0540851913f * fTemp9) - ((0.0437442064f * fTemp7) + (0.0204628017f * fTemp8))) - (fConst6 * fRec64[1])));
			fRec66[0] = (fRec66[1] + fTemp30);
			fRec64[0] = fRec66[0];
			float fRec65 = fTemp30;
			fVec19[(IOTA & 511)] = (fRec65 + (0.0189523026f * fTemp11));
			output19[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec19[((IOTA - iConst7) & 511)])));
			float fTemp31 = (fConst5 * (((0.0542847849f * fTemp9) - ((0.0176253803f * fTemp7) + (0.0444799475f * fTemp8))) - (fConst6 * fRec67[1])));
			fRec69[0] = (fRec69[1] + fTemp31);
			fRec67[0] = fRec69[0];
			float fRec68 = fTemp31;
			fVec20[(IOTA & 511)] = (fRec68 + (0.0186281949f * fTemp11));
			output20[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec20[((IOTA - iConst7) & 511)])));
			float fTemp32 = (fConst5 * ((((0.0171095449f * fTemp7) + (0.0545786284f * fTemp9)) - (0.0444330014f * fTemp8)) - (fConst6 * fRec70[1])));
			fRec72[0] = (fRec72[1] + fTemp32);
			fRec70[0] = fRec72[0];
			float fRec71 = fTemp32;
			fVec21[(IOTA & 511)] = (fRec71 + (0.0183431953f * fTemp11));
			output21[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec21[((IOTA - iConst7) & 511)])));
			float fTemp33 = (fConst5 * ((((0.0436177254f * fTemp7) + (0.0548248515f * fTemp9)) - (0.0196551681f * fTemp8)) - (fConst6 * fRec73[1])));
			fRec75[0] = (fRec75[1] + fTemp33);
			fRec73[0] = fRec75[0];
			float fRec74 = fTemp33;
			fVec22[(IOTA & 511)] = (fRec74 + (0.0182386469f * fTemp11));
			output22[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec22[((IOTA - iConst7) & 511)])));
			float fTemp34 = (fConst5 * ((((0.0446064696f * fTemp7) + (0.0548668243f * fTemp9)) + (0.0181924049f * fTemp8)) - (fConst6 * fRec76[1])));
			fRec78[0] = (fRec78[1] + fTemp34);
			fRec76[0] = fRec78[0];
			float fRec77 = fTemp34;
			fVec23[(IOTA & 511)] = (fRec77 + (0.0184033103f * fTemp11));
			output23[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec23[((IOTA - iConst7) & 511)])));
			float fTemp35 = (fConst8 * ((((0.0147448536f * fTemp7) + (0.115613356f * fTemp9)) + (0.0149938976f * fTemp8)) - (fConst9 * fRec79[1])));
			fRec81[0] = (fRec81[1] + fTemp35);
			fRec79[0] = fRec81[0];
			float fRec80 = fTemp35;
			fVec24[(IOTA & 255)] = (fRec80 + (0.00381974597f * fTemp11));
			output24[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec24[((IOTA - iConst10) & 255)])));
			float fTemp36 = (fConst8 * ((((0.115363918f * fTemp9) + (0.0149546321f * fTemp8)) - (0.0147405099f * fTemp7)) - (fConst9 * fRec82[1])));
			fRec84[0] = (fRec84[1] + fTemp36);
			fRec82[0] = fRec84[0];
			float fRec83 = fTemp36;
			fVec25[(IOTA & 255)] = (fRec83 + (0.00406167563f * fTemp11));
			output25[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec25[((IOTA - iConst10) & 255)])));
			float fTemp37 = (fConst8 * (((0.115337551f * fTemp9) - ((0.0147797754f * fTemp7) + (0.0143643841f * fTemp8))) - (fConst9 * fRec85[1])));
			fRec87[0] = (fRec87[1] + fTemp37);
			fRec85[0] = fRec87[0];
			float fRec86 = fTemp37;
			fVec26[(IOTA & 255)] = (fRec86 + (0.00392815098f * fTemp11));
			output26[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec26[((IOTA - iConst10) & 255)])));
			float fTemp38 = (fConst8 * ((((0.0147055881f * fTemp7) + (0.115586989f * fTemp9)) - (0.0143251186f * fTemp8)) - (fConst9 * fRec88[1])));
			fRec90[0] = (fRec90[1] + fTemp38);
			fRec88[0] = fRec90[0];
			float fRec89 = fTemp38;
			fVec27[(IOTA & 255)] = (fRec89 + (0.00368622132f * fTemp11));
			output27[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec27[((IOTA - iConst10) & 255)])));
			float fTemp39 = (fConst11 * ((((1.49327998e-05f * fTemp7) + (0.126367912f * fTemp9)) + (0.000318181497f * fTemp8)) - (fConst12 * fRec91[1])));
			fRec93[0] = (fRec93[1] + fTemp39);
			fRec91[0] = fRec93[0];
			float fRec92 = fTemp39;
			output28[i] = FAUSTFLOAT((fRec0[0] * (fRec92 + (0.00122856174f * fTemp11))));
			float fTemp40 = (fConst1 * ((((0.0234277062f * fTemp7) + (0.0535013787f * fTemp8)) - (0.0492804982f * fTemp9)) - (fConst3 * fRec94[1])));
			fRec96[0] = (fRec96[1] + fTemp40);
			fRec94[0] = fRec96[0];
			float fRec95 = fTemp40;
			fVec28[(IOTA & 1023)] = (fRec95 + (0.0439944156f * fTemp11));
			output29[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec28[((IOTA - iConst4) & 1023)])));
			float fTemp41 = (fConst1 * ((((0.00107438699f * fTemp7) + (0.0585042946f * fTemp8)) - (0.0494651273f * fTemp9)) - (fConst3 * fRec97[1])));
			fRec99[0] = (fRec99[1] + fTemp41);
			fRec97[0] = fRec99[0];
			float fRec98 = fTemp41;
			fVec29[(IOTA & 1023)] = (fRec98 + (0.0442008004f * fTemp11));
			output30[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec29[((IOTA - iConst4) & 1023)])));
			float fTemp42 = (fConst1 * (((0.0545212701f * fTemp8) - ((0.0216983017f * fTemp7) + (0.0496612862f * fTemp9))) - (fConst3 * fRec100[1])));
			fRec102[0] = (fRec102[1] + fTemp42);
			fRec100[0] = fRec102[0];
			float fRec101 = fTemp42;
			fVec30[(IOTA & 1023)] = (fRec101 + (0.0443696082f * fTemp11));
			output31[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec30[((IOTA - iConst4) & 1023)])));
			float fTemp43 = (fConst1 * (((0.042166099f * fTemp8) - ((0.0410997272f * fTemp7) + (0.0498363636f * fTemp9))) - (fConst3 * fRec103[1])));
			fRec105[0] = (fRec105[1] + fTemp43);
			fRec103[0] = fRec105[0];
			float fRec104 = fTemp43;
			fVec31[(IOTA & 1023)] = (fRec104 + (0.0444725119f * fTemp11));
			output32[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec31[((IOTA - iConst4) & 1023)])));
			float fTemp44 = (fConst1 * (((0.0229782332f * fTemp8) - ((0.0543991514f * fTemp7) + (0.0499658957f * fTemp9))) - (fConst3 * fRec106[1])));
			fRec108[0] = (fRec108[1] + fTemp44);
			fRec106[0] = fRec108[0];
			float fRec107 = fTemp44;
			fVec32[(IOTA & 1023)] = (fRec107 + (0.0444941185f * fTemp11));
			output33[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec32[((IOTA - iConst4) & 1023)])));
			float fTemp45 = (fConst1 * (((0.000336313096f * fTemp8) - ((0.0590969473f * fTemp7) + (0.0500257388f * fTemp9))) - (fConst3 * fRec109[1])));
			fRec111[0] = (fRec111[1] + fTemp45);
			fRec109[0] = fRec111[0];
			float fRec110 = fTemp45;
			fVec33[(IOTA & 1023)] = (fRec110 + (0.0444293283f * fTemp11));
			output34[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec33[((IOTA - iConst4) & 1023)])));
			float fTemp46 = (fConst1 * ((0.0f - (((0.0544011109f * fTemp7) + (0.0500065088f * fTemp9)) + (0.0227341726f * fTemp8))) - (fConst3 * fRec112[1])));
			fRec114[0] = (fRec114[1] + fTemp46);
			fRec112[0] = fRec114[0];
			float fRec113 = fTemp46;
			fVec34[(IOTA & 1023)] = (fRec113 + (0.0442854501f * fTemp11));
			output35[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec34[((IOTA - iConst4) & 1023)])));
			float fTemp47 = (fConst1 * ((0.0f - (((0.0409823768f * fTemp7) + (0.0499100871f * fTemp9)) + (0.0419674367f * fTemp8))) - (fConst3 * fRec115[1])));
			fRec117[0] = (fRec117[1] + fTemp47);
			fRec115[0] = fRec117[0];
			float fRec116 = fTemp47;
			fVec35[(IOTA & 1023)] = (fRec116 + (0.0440874621f * fTemp11));
			output36[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec35[((IOTA - iConst4) & 1023)])));
			float fTemp48 = (fConst1 * ((0.0f - (((0.0219920855f * fTemp7) + (0.0497601405f * fTemp9)) + (0.0539946184f * fTemp8))) - (fConst3 * fRec118[1])));
			fRec120[0] = (fRec120[1] + fTemp48);
			fRec118[0] = fRec120[0];
			float fRec119 = fTemp48;
			fVec36[(IOTA & 1023)] = (fRec119 + (0.0438766256f * fTemp11));
			output37[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec36[((IOTA - iConst4) & 1023)])));
			float fTemp49 = (fConst1 * ((0.0f - (((0.000779602386f * fTemp7) + (0.0495842695f * fTemp9)) + (0.0579956844f * fTemp8))) - (fConst3 * fRec121[1])));
			fRec123[0] = (fRec123[1] + fTemp49);
			fRec121[0] = fRec123[0];
			float fRec122 = fTemp49;
			fVec37[(IOTA & 1023)] = (fRec122 + (0.0436841808f * fTemp11));
			output38[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec37[((IOTA - iConst4) & 1023)])));
			float fTemp50 = (fConst1 * (((0.0229522288f * fTemp7) - ((0.0493791513f * fTemp9) + (0.0530588478f * fTemp8))) - (fConst3 * fRec124[1])));
			fRec126[0] = (fRec126[1] + fTemp50);
			fRec124[0] = fRec126[0];
			float fRec125 = fTemp50;
			fVec38[(IOTA & 1023)] = (fRec125 + (0.0435118526f * fTemp11));
			output39[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec38[((IOTA - iConst4) & 1023)])));
			float fTemp51 = (fConst1 * (((0.0411959067f * fTemp7) - ((0.0492137261f * fTemp9) + (0.0405457877f * fTemp8))) - (fConst3 * fRec127[1])));
			fRec129[0] = (fRec129[1] + fTemp51);
			fRec127[0] = fRec129[0];
			float fRec128 = fTemp51;
			fVec39[(IOTA & 1023)] = (fRec128 + (0.0434191748f * fTemp11));
			output40[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec39[((IOTA - iConst4) & 1023)])));
			float fTemp52 = (fConst1 * (((0.0534494035f * fTemp7) - ((0.049093876f * fTemp9) + (0.0222963896f * fTemp8))) - (fConst3 * fRec130[1])));
			fRec132[0] = (fRec132[1] + fTemp52);
			fRec130[0] = fRec132[0];
			float fRec131 = fTemp52;
			fVec40[(IOTA & 1023)] = (fRec131 + (0.0434018709f * fTemp11));
			output41[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec40[((IOTA - iConst4) & 1023)])));
			float fTemp53 = (fConst1 * (((0.0580399074f * fTemp7) - ((0.049036812f * fTemp9) + (0.00176421902f * fTemp8))) - (fConst3 * fRec133[1])));
			fRec135[0] = (fRec135[1] + fTemp53);
			fRec133[0] = fRec135[0];
			float fRec134 = fTemp53;
			fVec41[(IOTA & 1023)] = (fRec134 + (0.0434579104f * fTemp11));
			output42[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec41[((IOTA - iConst4) & 1023)])));
			float fTemp54 = (fConst1 * ((((0.0540367961f * fTemp7) + (0.021677224f * fTemp8)) - (0.0490498543f * fTemp9)) - (fConst3 * fRec136[1])));
			fRec138[0] = (fRec138[1] + fTemp54);
			fRec136[0] = fRec138[0];
			float fRec137 = fTemp54;
			fVec42[(IOTA & 1023)] = (fRec137 + (0.0435977951f * fTemp11));
			output43[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec42[((IOTA - iConst4) & 1023)])));
			float fTemp55 = (fConst1 * ((((0.0423563533f * fTemp7) + (0.0400928035f * fTemp8)) - (0.0491322987f * fTemp9)) - (fConst3 * fRec139[1])));
			fRec141[0] = (fRec141[1] + fTemp55);
			fRec139[0] = fRec141[0];
			float fRec140 = fTemp55;
			fVec43[(IOTA & 1023)] = (fRec140 + (0.043777775f * fTemp11));
