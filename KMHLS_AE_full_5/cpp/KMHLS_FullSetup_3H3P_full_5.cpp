 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp15 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec10[1]) + (fConst4 * fRec7[1])))) + (fConst7 * ((((0.0708951578f * fTemp8) + (0.0388607197f * fTemp9)) + (0.0147945061f * fTemp10)) - ((((0.0126922177f * fTemp11) + (0.0379042514f * fTemp12)) + (0.0170685947f * fTemp13)) + (0.0168841612f * fTemp14))))));
			...
			float fTemp20 = (fConst9 * ((((0.024182668f * fTemp17) + (0.0155895092f * fTemp18)) + (0.034650255f * fTemp19)) - (fConst10 * fRec20[1])));
			...
			float fTemp26 = (fConst11 * ((((((0.0508126915f * fTemp21) + (0.0119186398f * fTemp22)) + (0.0180829018f * fTemp23)) + (0.0192373414f * fTemp24)) - (0.0154854022f * fTemp25)) + (fConst3 * (0.0f - ((fConst13 * fRec29[1]) + (fConst12 * fRec26[1]))))));
			...
			fRec26[0] = fRec28[0];
			float fRec27 = fRec30;
			fVec0[(IOTA & 1023)] = ((0.0123009244f * fTemp7) + (fRec5 + (fRec21 + fRec27)));
			output0[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec0[((IOTA - iConst14) & 1023)])));
			float fTemp27 = (fConst9 * ((((0.00962866377f * fTemp17) + (0.0154505149f * fTemp18)) + (0.0413556211f * fTemp19)) - (fConst10 * fRec37[1])));
			fRec39[0] = (fRec39[1] + fTemp27);
			fRec37[0] = fRec39[0];
			float fRec38 = fTemp27;
			float fTemp28 = (fConst11 * ((((((0.0248185303f * fTemp21) + (0.0046827211f * fTemp22)) + (0.0219704472f * fTemp23)) + (0.0494921431f * fTemp24)) - (0.0154684493f * fTemp25)) + (fConst3 * (0.0f - ((fConst13 * fRec43[1]) + (fConst12 * fRec40[1]))))));
			...
			fRec40[0] = fRec42[0];
			float fRec41 = fRec44;
			float fTemp29 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec52[1]) + (fConst4 * fRec49[1])))) + (fConst7 * (((((0.0469385944f * fTemp8) + (0.0189808086f * fTemp9)) + (0.03806201f * fTemp10)) + (0.0566239022f * fTemp14)) - (((0.00507375784f * fTemp11) + (0.0377095118f * fTemp12)) + (0.0201032832f * fTemp13))))));
			...
			fRec49[0] = fRec51[0];
			float fRec50 = fRec53;
			float fTemp30 = (fConst8 * fRec46[1]);
			fRec48[0] = ((fRec50 + fRec48[1]) - fTemp30);
			fRec46[0] = fRec48[0];
			float fRec47 = (fRec50 - fTemp30);
			fVec1[(IOTA & 1023)] = ((0.0122213094f * fTemp7) + (fRec38 + (fRec41 + fRec47)));
			output1[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec1[((IOTA - iConst14) & 1023)])));
			float fTemp31 = (fConst9 * ((((0.0155618247f * fTemp18) + (0.0422560461f * fTemp19)) - (0.00780235277f * fTemp17)) - (fConst10 * fRec55[1])));
			fRec57[0] = (fRec57[1] + fTemp31);
			fRec55[0] = fRec57[0];
			float fRec56 = fTemp31;
			float fTemp32 = (fConst11 * ((((0.0222727656f * fTemp23) + (0.0519239195f * fTemp24)) - (((0.0194460563f * fTemp21) + (0.00364541705f * fTemp22)) + (0.0152157797f * fTemp25))) + (fConst3 * (0.0f - ((fConst13 * fRec61[1]) + (fConst12 * fRec58[1]))))));
			fRec63[0] = (fRec63[1] + fTemp32);
			fRec61[0] = fRec63[0];
			float fRec62 = fTemp32;
			fRec60[0] = (fRec61[0] + fRec60[1]);
			fRec58[0] = fRec60[0];
			float fRec59 = fRec62;
			float fTemp33 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec70[1]) + (fConst4 * fRec67[1])))) + (fConst7 * ((((0.00432214979f * fTemp11) + (0.0399321727f * fTemp10)) + (0.0625178367f * fTemp14)) - ((((0.0384561084f * fTemp8) + (0.0148720276f * fTemp9)) + (0.0380283184f * fTemp12)) + (0.0208088979f * fTemp13))))));
			fRec72[0] = (fRec72[1] + fTemp33);
			fRec70[0] = fRec72[0];
			float fRec71 = fTemp33;
			fRec69[0] = (fRec70[0] + fRec69[1]);
			fRec67[0] = fRec69[0];
			float fRec68 = fRec71;
			float fTemp34 = (fConst8 * fRec64[1]);
			fRec66[0] = ((fRec68 + fRec66[1]) - fTemp34);
			fRec64[0] = fRec66[0];
			float fRec65 = (fRec68 - fTemp34);
			fVec2[(IOTA & 1023)] = ((0.0121222418f * fTemp7) + (fRec56 + (fRec59 + fRec65)));
			output2[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec2[((IOTA - iConst14) & 1023)])));
			float fTemp35 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec79[1]) + (fConst4 * fRec76[1])))) + (fConst7 * (((0.011685282f * fTemp11) + (0.0184290688f * fTemp10)) - (((((0.0731076151f * fTemp8) + (0.0381095111f * fTemp9)) + (0.0383943841f * fTemp12)) + (0.0184681173f * fTemp13)) + (0.00860925205f * fTemp14))))));
			...
			float fTemp37 = (fConst9 * ((((0.0157878026f * fTemp18) + (0.036525175f * fTemp19)) - (0.0225942004f * fTemp17)) - (fConst10 * fRec82[1])));
			fRec84[0] = (fRec84[1] + fTemp37);
			fRec82[0] = fRec84[0];
			float fRec83 = fTemp37;
			float fTemp38 = (fConst11 * ((((0.0187510047f * fTemp23) + (0.0239633732f * fTemp24)) - (((0.0498304404f * fTemp21) + (0.0112395436f * fTemp22)) + (0.0152348485f * fTemp25))) + (fConst3 * (0.0f - ((fConst13 * fRec88[1]) + (fConst12 * fRec85[1]))))));
			...
			fRec85[0] = fRec87[0];
			float fRec86 = fRec89;
			fVec3[(IOTA & 1023)] = ((0.0122375237f * fTemp7) + (fRec74 + (fRec83 + fRec86)));
			output3[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec3[((IOTA - iConst14) & 1023)])));
			float fTemp39 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec97[1]) + (fConst4 * fRec94[1])))) + (fConst7 * ((0.0174415782f * fTemp11) - ((((((0.0162029974f * fTemp8) + (0.039489843f * fTemp9)) + (0.0385938622f * fTemp12)) + (0.0124782287f * fTemp13)) + (0.0160798393f * fTemp10)) + (0.071937263f * fTemp14))))));
			...
			float fTemp41 = (fConst9 * ((((0.0160102267f * fTemp18) + (0.0240786336f * fTemp19)) - (0.0354899652f * fTemp17)) - (fConst10 * fRec100[1])));
			fRec102[0] = (fRec102[1] + fTemp41);
			fRec100[0] = fRec102[0];
			float fRec101 = fTemp41;
			float fTemp42 = (fConst11 * (((0.0119758034f * fTemp23) - ((((0.0516353063f * fTemp21) + (0.0185525119f * fTemp22)) + (0.0155942794f * fTemp25)) + (0.020908663f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec106[1]) + (fConst12 * fRec103[1]))))));
			...
			fVec4[(IOTA & 1023)] = ((0.0125496965f * fTemp7) + (fRec92 + (fRec101 + fRec104)));
			output4[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec4[((IOTA - iConst14) & 1023)])));
			float fTemp43 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec115[1]) + (fConst4 * fRec112[1])))) + (fConst7 * (((0.0602422059f * fTemp8) + (0.0207294654f * fTemp11)) - (((((0.0167796463f * fTemp9) + (0.0386239178f * fTemp12)) + (0.00427841442f * fTemp13)) + (0.0397701152f * fTemp10)) + (0.0424549766f * fTemp14))))));
			...
			float fTemp45 = (fConst9 * ((((0.0160946157f * fTemp18) + (0.00846808031f * fTemp19)) - (0.0425965115f * fTemp17)) - (fConst10 * fRec118[1])));
			fRec120[0] = (fRec120[1] + fTemp45);
			fRec118[0] = fRec120[0];
			float fRec119 = fTemp45;
			float fTemp46 = (fConst11 * (((0.00424431358f * fTemp23) - ((((0.0219403785f * fTemp21) + (0.022618534f * fTemp22)) + (0.0158733726f * fTemp25)) + (0.0517132021f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec124[1]) + (fConst12 * fRec121[1]))))));
			...
			fVec5[(IOTA & 1023)] = ((0.0127469804f * fTemp7) + (fRec110 + (fRec119 + fRec122)));
			output5[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec5[((IOTA - iConst14) & 1023)])));
			float fTemp47 = (fConst11 * (((0.0219779033f * fTemp21) - ((((0.02219503f * fTemp22) + (0.0157826357f * fTemp25)) + (0.00386806088f * fTemp23)) + (0.0520552061f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec130[1]) + (fConst12 * fRec127[1]))))));
			fRec132[0] = (fRec132[1] + fTemp47);
			fRec130[0] = fRec132[0];
			float fRec131 = fTemp47;
			fRec129[0] = (fRec130[0] + fRec129[1]);
			fRec127[0] = fRec129[0];
			float fRec128 = fRec131;
			float fTemp48 = (fConst9 * (((0.0159734245f * fTemp18) - ((0.0428106152f * fTemp17) + (0.00860518031f * fTemp19))) - (fConst10 * fRec133[1])));
			fRec135[0] = (fRec135[1] + fTemp48);
			fRec133[0] = fRec135[0];
			float fRec134 = fTemp48;
			float fTemp49 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec142[1]) + (fConst4 * fRec139[1])))) + (fConst7 * ((((((0.061554119f * fTemp8) + (0.0168083441f * fTemp9)) + (0.021602273f * fTemp11)) + (0.004984851f * fTemp13)) + (0.0421694033f * fTemp14)) - ((0.0385172442f * fTemp12) + (0.0400331393f * fTemp10))))));
			fRec144[0] = (fRec144[1] + fTemp49);
			fRec142[0] = fRec144[0];
			float fRec143 = fTemp49;
			fRec141[0] = (fRec142[0] + fRec141[1]);
			fRec139[0] = fRec141[0];
			float fRec140 = fRec143;
			float fTemp50 = (fConst8 * fRec136[1]);
			fRec138[0] = ((fRec140 + fRec138[1]) - fTemp50);
			fRec136[0] = fRec138[0];
			float fRec137 = (fRec140 - fTemp50);
			fVec6[(IOTA & 1023)] = ((0.0126277367f * fTemp7) + (fRec128 + (fRec134 + fRec137)));
			output6[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec6[((IOTA - iConst14) & 1023)])));
			float fTemp51 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec151[1]) + (fConst4 * fRec148[1])))) + (fConst7 * (((((0.0394103266f * fTemp9) + (0.0188998599f * fTemp11)) + (0.0131504927f * fTemp13)) + (0.0722958297f * fTemp14)) - (((0.0167639814f * fTemp8) + (0.0380997695f * fTemp12)) + (0.0156662073f * fTemp10))))));
			...
			float fTemp53 = (fConst9 * (((0.0156077724f * fTemp18) - ((0.0353121124f * fTemp17) + (0.0238745455f * fTemp19))) - (fConst10 * fRec154[1])));
			fRec156[0] = (fRec156[1] + fTemp53);
			fRec154[0] = fRec156[0];
			float fRec155 = fTemp53;
			float fTemp54 = (fConst11 * (((0.0515313298f * fTemp21) - ((((0.0173722915f * fTemp22) + (0.0154917259f * fTemp25)) + (0.0113253482f * fTemp23)) + (0.0203708168f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec160[1]) + (fConst12 * fRec157[1]))))));
			...
			fVec7[(IOTA & 1023)] = ((0.0122789666f * fTemp7) + (fRec146 + (fRec155 + fRec158)));
			output7[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec7[((IOTA - iConst14) & 1023)])));
			float fTemp55 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec169[1]) + (fConst4 * fRec166[1])))) + (fConst7 * ((((((0.0370045826f * fTemp9) + (0.0122734746f * fTemp11)) + (0.0189140085f * fTemp13)) + (0.0175725762f * fTemp10)) + (0.00957403984f * fTemp14)) - ((0.0712006614f * fTemp8) + (0.0373292454f * fTemp12))))));
			...
			float fTemp57 = (fConst9 * (((0.015115438f * fTemp18) - ((0.0220390595f * fTemp17) + (0.0350549594f * fTemp19))) - (fConst10 * fRec172[1])));
			fRec174[0] = (fRec174[1] + fTemp57);
			fRec172[0] = fRec174[0];
			float fRec173 = fTemp57;
			float fTemp58 = (fConst11 * ((((0.0483856834f * fTemp21) + (0.0228496734f * fTemp24)) - (((0.01034893f * fTemp22) + (0.0153989606f * fTemp25)) + (0.0171575658f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec178[1]) + (fConst12 * fRec175[1]))))));
			...
			fVec8[(IOTA & 1023)] = ((0.0119973551f * fTemp7) + (fRec164 + (fRec173 + fRec176)));
			output8[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec8[((IOTA - iConst14) & 1023)])));
			float fTemp59 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec187[1]) + (fConst4 * fRec184[1])))) + (fConst7 * (((((0.0144918272f * fTemp9) + (0.00382386008f * fTemp11)) + (0.0217269417f * fTemp13)) + (0.03868201f * fTemp10)) - (((0.0382190347f * fTemp8) + (0.0366626568f * fTemp12)) + (0.0608160198f * fTemp14))))));
			...
			float fTemp61 = (fConst9 * (((0.0147807319f * fTemp18) - ((0.0072266385f * fTemp17) + (0.040622443f * fTemp19))) - (fConst10 * fRec190[1])));
			fRec192[0] = (fRec192[1] + fTemp61);
			fRec190[0] = fRec192[0];
			float fRec191 = fTemp61;
			float fTemp62 = (fConst11 * ((((0.0189489201f * fTemp21) + (0.0502983332f * fTemp24)) - (((0.00349564198f * fTemp22) + (0.0155025851f * fTemp25)) + (0.0202038083f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec196[1]) + (fConst12 * fRec193[1]))))));
			...
			fVec9[(IOTA & 1023)] = ((0.0119161103f * fTemp7) + (fRec182 + (fRec191 + fRec194)));
			output9[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec9[((IOTA - iConst14) & 1023)])));
			float fTemp63 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec205[1]) + (fConst4 * fRec202[1])))) + (fConst7 * ((((0.0439214259f * fTemp8) + (0.0216984656f * fTemp13)) + (0.0383112058f * fTemp10)) - ((((0.017410662f * fTemp9) + (0.00535235368f * fTemp11)) + (0.0366280302f * fTemp12)) + (0.0592484437f * fTemp14))))));
			...
			float fTemp65 = (fConst9 * ((((0.00893379375f * fTemp17) + (0.0148080913f * fTemp18)) - (0.0405449867f * fTemp19)) - (fConst10 * fRec208[1])));
			fRec210[0] = (fRec210[1] + fTemp65);
			fRec208[0] = fRec210[0];
			float fRec209 = fTemp65;
			float fTemp66 = (fConst11 * ((((0.00389099424f * fTemp22) + (0.0498161763f * fTemp24)) - (((0.0227654707f * fTemp21) + (0.0154319536f * fTemp25)) + (0.0201524142f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec214[1]) + (fConst12 * fRec211[1]))))));
			...
			fVec10[(IOTA & 1023)] = ((0.011910486f * fTemp7) + (fRec200 + (fRec209 + fRec212)));
			output10[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec10[((IOTA - iConst14) & 1023)])));
			float fTemp67 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec223[1]) + (fConst4 * fRec220[1])))) + (fConst7 * (((((0.0710562617f * fTemp8) + (0.0183703899f * fTemp13)) + (0.0155560598f * fTemp10)) + (0.0147831328f * fTemp14)) - (((0.0379105881f * fTemp9) + (0.0122285942f * fTemp11)) + (0.0375199839f * fTemp12))))));
			...
			float fTemp69 = (fConst9 * ((((0.0229247529f * fTemp17) + (0.0152574684f * fTemp18)) - (0.0342396237f * fTemp19)) - (fConst10 * fRec226[1])));
			fRec228[0] = (fRec228[1] + fTemp69);
			fRec226[0] = fRec228[0];
			float fRec227 = fTemp69;
			float fTemp70 = (fConst11 * ((((0.0111505808f * fTemp22) + (0.0202275906f * fTemp24)) - (((0.0495703369f * fTemp21) + (0.0149091883f * fTemp25)) + (0.0168172047f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec232[1]) + (fConst12 * fRec229[1]))))));
			...
			fVec11[(IOTA & 1023)] = ((0.0118330847f * fTemp7) + (fRec218 + (fRec227 + fRec230)));
			output11[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec11[((IOTA - iConst14) & 1023)])));
			float fTemp71 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec241[1]) + (fConst4 * fRec238[1])))) + (fConst7 * ((((0.0139312604f * fTemp8) + (0.0121605806f * fTemp13)) + (0.0693311468f * fTemp14)) - ((((0.0370563604f * fTemp9) + (0.016617069f * fTemp11)) + (0.038809333f * fTemp12)) + (0.0157564841f * fTemp10))))));
			...
			float fTemp73 = (fConst9 * ((((0.0339126848f * fTemp17) + (0.0158617087f * fTemp18)) - (0.0228782985f * fTemp19)) - (fConst10 * fRec244[1])));
			fRec246[0] = (fRec246[1] + fTemp73);
			fRec244[0] = fRec246[0];
			float fRec245 = fTemp73;
			float fTemp74 = (fConst11 * (((0.0177666806f * fTemp22) - ((((0.0484533831f * fTemp21) + (0.0142018329f * fTemp25)) + (0.0111624645f * fTemp23)) + (0.0204882026f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec250[1]) + (fConst12 * fRec247[1]))))));
			...
			fVec12[(IOTA & 1023)] = ((0.0117086172f * fTemp7) + (fRec236 + (fRec245 + fRec248)));
			output12[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec12[((IOTA - iConst14) & 1023)])));
			float fTemp75 = (fConst9 * ((((0.0405580327f * fTemp17) + (0.0162616558f * fTemp18)) - (0.00870465487f * fTemp19)) - (fConst10 * fRec253[1])));
			fRec255[0] = (fRec255[1] + fTemp75);
			fRec253[0] = fRec255[0];
			float fRec254 = fTemp75;
			float fTemp76 = (fConst11 * (((0.0220115688f * fTemp22) - ((((0.0219795071f * fTemp21) + (0.0138698379f * fTemp25)) + (0.00438105967f * fTemp23)) + (0.0494978651f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec259[1]) + (fConst12 * fRec256[1]))))));
			fRec261[0] = (fRec261[1] + fTemp76);
			fRec259[0] = fRec261[0];
			float fRec260 = fTemp76;
			fRec258[0] = (fRec259[0] + fRec258[1]);
			fRec256[0] = fRec258[0];
			float fRec257 = fRec260;
			float fTemp77 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec268[1]) + (fConst4 * fRec265[1])))) + (fConst7 * (((0.00437464425f * fTemp13) + (0.0429454446f * fTemp14)) - (((((0.0581483431f * fTemp8) + (0.0168095697f * fTemp9)) + (0.0190633927f * fTemp11)) + (0.0396393351f * fTemp12)) + (0.0380664095f * fTemp10))))));
			fRec270[0] = (fRec270[1] + fTemp77);
			fRec268[0] = fRec270[0];
			float fRec269 = fTemp77;
			fRec267[0] = (fRec268[0] + fRec267[1]);
			fRec265[0] = fRec267[0];
			float fRec266 = fRec269;
			float fTemp78 = (fConst8 * fRec262[1]);
			fRec264[0] = ((fRec266 + fRec264[1]) - fTemp78);
			fRec262[0] = fRec264[0];
			float fRec263 = (fRec266 - fTemp78);
			fVec13[(IOTA & 1023)] = ((0.0116973966f * fTemp7) + (fRec254 + (fRec257 + fRec263)));
			output13[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec13[((IOTA - iConst14) & 1023)])));
			float fTemp79 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec277[1]) + (fConst4 * fRec274[1])))) + (fConst7 * ((0.0144104986f * fTemp9) - ((((((0.0633732304f * fTemp8) + (0.0198644865f * fTemp11)) + (0.0395383649f * fTemp12)) + (0.00429198751f * fTemp13)) + (0.0399109125f * fTemp10)) + (0.0378089808f * fTemp14))))));
			...
			float fTemp81 = (fConst9 * ((((0.0417335071f * fTemp17) + (0.016272625f * fTemp18)) + (0.00768157514f * fTemp19)) - (fConst10 * fRec280[1])));
			fRec282[0] = (fRec282[1] + fTemp81);
			fRec280[0] = fRec282[0];
			float fRec281 = fTemp81;
			float fTemp82 = (fConst11 * (((((0.0188425798f * fTemp21) + (0.0224841405f * fTemp22)) + (0.00356331631f * fTemp23)) - ((0.0142212333f * fTemp25) + (0.0518962778f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec286[1]) + (fConst12 * fRec283[1]))))));
			...
			fVec14[(IOTA & 1023)] = ((0.011897957f * fTemp7) + (fRec272 + (fRec281 + fRec284)));
			output14[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec14[((IOTA - iConst14) & 1023)])));
			float fTemp83 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec295[1]) + (fConst4 * fRec292[1])))) + (fConst7 * (((0.00786654372f * fTemp8) + (0.0370525345f * fTemp9)) - (((((0.0180939361f * fTemp11) + (0.0387206785f * fTemp12)) + (0.011496013f * fTemp13)) + (0.0188213028f * fTemp10)) + (0.0724194348f * fTemp14))))));
			...
			float fTemp85 = (fConst9 * ((((0.0362238176f * fTemp17) + (0.0159579422f * fTemp18)) + (0.0223802608f * fTemp19)) - (fConst10 * fRec298[1])));
			fRec300[0] = (fRec300[1] + fTemp85);
			fRec298[0] = fRec300[0];
			float fRec299 = fTemp85;
			float fTemp86 = (fConst11 * (((((0.0484483801f * fTemp21) + (0.0187538229f * fTemp22)) + (0.0111883273f * fTemp23)) - ((0.0149566904f * fTemp25) + (0.0244733952f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec304[1]) + (fConst12 * fRec301[1]))))));
			...
			fVec15[(IOTA & 1023)] = ((0.0121714016f * fTemp7) + (fRec290 + (fRec299 + fRec302)));
			output15[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec15[((IOTA - iConst14) & 1023)])));
			float fTemp87 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec313[1]) + (fConst16 * fRec310[1])))) + (fConst19 * (((((((0.0399772152f * fTemp8) + (0.0298000593f * fTemp9)) + (0.033810962f * fTemp11)) + (0.083858408f * fTemp13)) + (0.030588109f * fTemp10)) + (0.0189047437f * fTemp14)) - (0.0995325521f * fTemp12)))));
			...
			float fTemp89 = (fConst21 * ((((0.0184467845f * fTemp17) + (0.0559589267f * fTemp18)) + (0.0440197252f * fTemp19)) - (fConst22 * fRec316[1])));
			fRec318[0] = (fRec318[1] + fTemp89);
			fRec316[0] = fRec318[0];
			float fRec317 = fTemp89;
			float fTemp90 = (fConst23 * ((((((0.0389653407f * fTemp21) + (0.0396744162f * fTemp22)) + (0.0336897634f * fTemp25)) + (0.097202681f * fTemp23)) + (0.0397738107f * fTemp24)) + (fConst3 * (0.0f - ((fConst25 * fRec322[1]) + (fConst24 * fRec319[1]))))));
			...
			fVec16[(IOTA & 511)] = ((0.00801534671f * fTemp7) + (fRec308 + (fRec317 + fRec320)));
			output16[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec16[((IOTA - iConst26) & 511)])));
			float fTemp91 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec331[1]) + (fConst16 * fRec328[1])))) + (fConst19 * ((((0.0829836875f * fTemp13) + (0.0303990338f * fTemp10)) + (0.016039921f * fTemp14)) - ((((0.0407872461f * fTemp8) + (0.0306160469f * fTemp9)) + (0.0355277173f * fTemp11)) + (0.100409701f * fTemp12))))));
			...
			float fTemp93 = (fConst21 * ((((0.056271486f * fTemp18) + (0.0444832407f * fTemp19)) - (0.0187465642f * fTemp17)) - (fConst22 * fRec334[1])));
			fRec336[0] = (fRec336[1] + fTemp93);
			fRec334[0] = fRec336[0];
			float fRec335 = fTemp93;
			float fTemp94 = (fConst23 * (((((0.0342967845f * fTemp25) + (0.0969837308f * fTemp23)) + (0.0395279564f * fTemp24)) - ((0.0400322899f * fTemp21) + (0.041138567f * fTemp22))) + (fConst3 * (0.0f - ((fConst25 * fRec340[1]) + (fConst24 * fRec337[1]))))));
			...
			fVec17[(IOTA & 511)] = ((0.00779080205f * fTemp7) + (fRec326 + (fRec335 + fRec338)));
			output17[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec17[((IOTA - iConst26) & 511)])));
			float fTemp95 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec349[1]) + (fConst16 * fRec346[1])))) + (fConst19 * (((0.0211780835f * fTemp8) + (0.0325874165f * fTemp13)) - (((((0.028689079f * fTemp9) + (0.0851336196f * fTemp11)) + (0.100428164f * fTemp12)) + (0.0326334685f * fTemp10)) + (0.0399226695f * fTemp14))))));
			...
			float fTemp97 = (fConst21 * ((((0.0563432425f * fTemp18) + (0.0172907002f * fTemp19)) - (0.0456994623f * fTemp17)) - (fConst22 * fRec352[1])));
			fRec354[0] = (fRec354[1] + fTemp97);
			fRec352[0] = fRec354[0];
			float fRec353 = fTemp97;
			float fTemp98 = (fConst23 * ((((0.033848092f * fTemp25) + (0.0378104746f * fTemp23)) - (((0.0375126675f * fTemp21) + (0.099564068f * fTemp22)) + (0.042433396f * fTemp24))) + (fConst3 * (0.0f - ((fConst25 * fRec358[1]) + (fConst24 * fRec355[1]))))));
			...
			fVec18[(IOTA & 511)] = ((0.00806307327f * fTemp7) + (fRec344 + (fRec353 + fRec356)));
			output18[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec18[((IOTA - iConst26) & 511)])));
			float fTemp99 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec367[1]) + (fConst16 * fRec364[1])))) + (fConst19 * ((((0.0122124022f * fTemp8) + (0.0329391696f * fTemp9)) + (0.0432781428f * fTemp14)) - ((((0.0812472701f * fTemp11) + (0.0985068381f * fTemp12)) + (0.0370105393f * fTemp13)) + (0.0282205921f * fTemp10))))));
			...
			float fTemp101 = (fConst21 * (((0.0552566722f * fTemp18) - ((0.0438648537f * fTemp17) + (0.0200384557f * fTemp19))) - (fConst22 * fRec370[1])));
			fRec372[0] = (fRec372[1] + fTemp101);
			fRec370[0] = fRec372[0];
			float fRec371 = fTemp101;
			float fTemp102 = (fConst23 * ((((0.043069914f * fTemp21) + (0.0332243517f * fTemp25)) - (((0.0952168033f * fTemp22) + (0.0432962924f * fTemp23)) + (0.0366953202f * fTemp24))) + (fConst3 * (0.0f - ((fConst25 * fRec376[1]) + (fConst24 * fRec373[1]))))));
			...
			fVec19[(IOTA & 511)] = ((0.00789030734f * fTemp7) + (fRec362 + (fRec371 + fRec374)));
			output19[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec19[((IOTA - iConst26) & 511)])));
			float fTemp103 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec385[1]) + (fConst16 * fRec382[1])))) + (fConst19 * (((0.0275552515f * fTemp9) + (0.0307415184f * fTemp10)) - (((((0.0380977094f * fTemp8) + (0.0327752046f * fTemp11)) + (0.0958115384f * fTemp12)) + (0.0817116797f * fTemp13)) + (0.0189584848f * fTemp14))))));
			...
			float fTemp105 = (fConst21 * (((0.0538105033f * fTemp18) - ((0.0164769515f * fTemp17) + (0.0430939943f * fTemp19))) - (fConst22 * fRec388[1])));
			fRec390[0] = (fRec390[1] + fTemp105);
			fRec388[0] = fRec390[0];
			float fRec389 = fTemp105;
			float fTemp106 = (fConst23 * (((((0.0360301211f * fTemp21) + (0.0326025337f * fTemp25)) + (0.039973285f * fTemp24)) - ((0.0372398831f * fTemp22) + (0.0948905647f * fTemp23))) + (fConst3 * (0.0f - ((fConst25 * fRec394[1]) + (fConst24 * fRec391[1]))))));
			...
			fVec20[(IOTA & 511)] = ((0.00758672738f * fTemp7) + (fRec380 + (fRec389 + fRec392)));
			output20[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec20[((IOTA - iConst26) & 511)])));
			float fTemp107 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec403[1]) + (fConst16 * fRec400[1])))) + (fConst19 * ((((0.0383615121f * fTemp8) + (0.0318975486f * fTemp11)) + (0.0312619433f * fTemp10)) - ((((0.0283719189f * fTemp9) + (0.0954447463f * fTemp12)) + (0.0819020867f * fTemp13)) + (0.0208030585f * fTemp14))))));
			...
			float fTemp109 = (fConst21 * ((((0.0172478408f * fTemp17) + (0.0537510552f * fTemp18)) - (0.0431523137f * fTemp19)) - (fConst22 * fRec406[1])));
			fRec408[0] = (fRec408[1] + fTemp109);
			fRec406[0] = fRec408[0];
			float fRec407 = fTemp109;
			float fTemp110 = (fConst23 * (((((0.0372927748f * fTemp22) + (0.0325442553f * fTemp25)) + (0.0406499989f * fTemp24)) - ((0.0370979644f * fTemp21) + (0.0950797796f * fTemp23))) + (fConst3 * (0.0f - ((fConst25 * fRec412[1]) + (fConst24 * fRec409[1]))))));
			...
			fVec21[(IOTA & 511)] = ((0.00764205307f * fTemp7) + (fRec398 + (fRec407 + fRec410)));
			output21[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec21[((IOTA - iConst26) & 511)])));
			float fTemp111 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec421[1]) + (fConst16 * fRec418[1])))) + (fConst19 * (((0.0833548233f * fTemp11) + (0.0405348353f * fTemp14)) - (((((0.0139949918f * fTemp8) + (0.0309747607f * fTemp9)) + (0.0981417298f * fTemp12)) + (0.0366415642f * fTemp13)) + (0.0284579955f * fTemp10))))));
			...
			float fTemp113 = (fConst21 * ((((0.042869281f * fTemp17) + (0.0551836789f * fTemp18)) - (0.0190945193f * fTemp19)) - (fConst22 * fRec424[1])));
			fRec426[0] = (fRec426[1] + fTemp113);
			fRec424[0] = fRec426[0];
			float fRec425 = fTemp113;
			float fTemp114 = (fConst23 * ((((0.0958363712f * fTemp22) + (0.0336526111f * fTemp25)) - (((0.04050133f * fTemp21) + (0.0422239155f * fTemp23)) + (0.0370040163f * fTemp24))) + (fConst3 * (0.0f - ((fConst25 * fRec430[1]) + (fConst24 * fRec427[1]))))));
			...
			fVec22[(IOTA & 511)] = ((0.00769722089f * fTemp7) + (fRec416 + (fRec425 + fRec428)));
			output22[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec22[((IOTA - iConst26) & 511)])));
			float fTemp115 = (fConst21 * ((((0.0448051915f * fTemp17) + (0.0559989624f * fTemp18)) + (0.0176903028f * fTemp19)) - (fConst22 * fRec433[1])));
			fRec435[0] = (fRec435[1] + fTemp115);
			fRec433[0] = fRec435[0];
			float fRec434 = fTemp115;
			float fTemp116 = (fConst23 * ((((((0.0382739566f * fTemp21) + (0.0983394906f * fTemp22)) + (0.0337659195f * fTemp25)) + (0.0388905369f * fTemp23)) - (0.0414146073f * fTemp24)) + (fConst3 * (0.0f - ((fConst25 * fRec439[1]) + (fConst24 * fRec436[1]))))));
			...
			float fTemp117 = (fConst15 * ((fConst3 * (0.0f - ((fConst17 * fRec448[1]) + (fConst16 * fRec445[1])))) + (fConst19 * ((((0.029271299f * fTemp9) + (0.0845030919f * fTemp11)) + (0.0336278081f * fTemp13)) - ((((0.0194336511f * fTemp8) + (0.0995538905f * fTemp12)) + (0.0318499692f * fTemp10)) + (0.0391252115f * fTemp14))))));
			...
			fVec23[(IOTA & 511)] = ((0.00800579973f * fTemp7) + (fRec434 + (fRec437 + fRec443)));
			output23[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec23[((IOTA - iConst26) & 511)])));
			float fTemp119 = (fConst27 * ((fConst3 * (0.0f - ((fConst29 * fRec457[1]) + (fConst28 * fRec454[1])))) + (fConst31 * ((((((0.00171834044f * fTemp8) + (0.0105854748f * fTemp9)) + (0.0839697123f * fTemp11)) + (0.0805927962f * fTemp12)) + (0.0829964057f * fTemp13)) - ((7.62240006e-06f * fTemp10) + (0.00141353253f * fTemp14))))));
			...
			float fTemp121 = (fConst33 * ((((0.0184970908f * fTemp17) + (0.0503051728f * fTemp18)) + (0.0177104846f * fTemp19)) - (fConst34 * fRec460[1])));
			fRec462[0] = (fRec462[1] + fTemp121);
			fRec460[0] = fRec462[0];
			float fRec461 = fTemp121;
			float fTemp122 = (fConst35 * ((((((0.0138411345f * fTemp21) + (0.0750454664f * fTemp22)) + (0.0572606772f * fTemp25)) + (0.0736790448f * fTemp23)) - (9.91140041e-06f * fTemp24)) + (fConst3 * (0.0f - ((fConst37 * fRec466[1]) + (fConst36 * fRec463[1]))))));
			...
			fVec24[(IOTA & 255)] = ((0.0284961034f * fTemp7) + (fRec452 + (fRec461 + fRec464)));
			output24[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec24[((IOTA - iConst38) & 255)])));
			float fTemp123 = (fConst27 * ((fConst3 * (0.0f - ((fConst29 * fRec475[1]) + (fConst28 * fRec472[1])))) + (fConst31 * ((((0.0795220584f * fTemp12) + (0.0830194429f * fTemp13)) + (0.000342163607f * fTemp10)) - ((((0.00144111505f * fTemp8) + (0.0105853491f * fTemp9)) + (0.0841325f * fTemp11)) + (0.00275591016f * fTemp14))))));
			...
			float fTemp125 = (fConst33 * ((((0.0506440625f * fTemp18) + (0.0179937407f * fTemp19)) - (0.0185244922f * fTemp17)) - (fConst34 * fRec478[1])));
			fRec480[0] = (fRec480[1] + fTemp125);
			fRec478[0] = fRec480[0];
			float fRec479 = fTemp125;
			float fTemp126 = (fConst35 * (((((0.0579839461f * fTemp25) + (0.0739379078f * fTemp23)) + (0.00044491631f * fTemp24)) - ((0.0138409706f * fTemp21) + (0.0751843378f * fTemp22))) + (fConst3 * (0.0f - ((fConst37 * fRec484[1]) + (fConst36 * fRec481[1]))))));
			...
			fVec25[(IOTA & 255)] = ((0.0281966422f * fTemp7) + (fRec470 + (fRec479 + fRec482)));
			output25[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec25[((IOTA - iConst38) & 255)])));
			float fTemp127 = (fConst27 * ((fConst3 * (0.0f - ((fConst29 * fRec493[1]) + (fConst28 * fRec490[1])))) + (fConst31 * ((((0.0100333244f * fTemp9) + (0.082813397f * fTemp12)) + (0.0020887237f * fTemp14)) - ((((0.00141023647f * fTemp8) + (0.0838650241f * fTemp11)) + (0.082294248f * fTemp13)) + (0.000404731603f * fTemp10))))));
			...
			float fTemp129 = (fConst33 * (((0.0489155054f * fTemp18) - ((0.0181749202f * fTemp17) + (0.0175483134f * fTemp19))) - (fConst34 * fRec496[1])));
			fRec498[0] = (fRec498[1] + fTemp129);
			fRec496[0] = fRec498[0];
			float fRec497 = fTemp129;
			float fTemp130 = (fConst35 * ((((0.0131191649f * fTemp21) + (0.0566684045f * fTemp25)) - (((0.0746927485f * fTemp22) + (0.0730431974f * fTemp23)) + (0.000526273623f * fTemp24))) + (fConst3 * (0.0f - ((fConst37 * fRec502[1]) + (fConst36 * fRec499[1]))))));
			...
			fVec26[(IOTA & 255)] = ((0.028127009f * fTemp7) + (fRec488 + (fRec497 + fRec500)));
			output26[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec26[((IOTA - iConst38) & 255)])));
			float fTemp131 = (fConst27 * ((fConst3 * (0.0f - ((fConst29 * fRec511[1]) + (fConst28 * fRec508[1])))) + (fConst31 * (((((0.00119686988f * fTemp8) + (0.0841358826f * fTemp11)) + (0.0837142318f * fTemp12)) + (0.00212740898f * fTemp14)) - (((0.0102164447f * fTemp9) + (0.0825887397f * fTemp13)) + (0.000442477991f * fTemp10))))));
			...
			float fTemp133 = (fConst33 * ((((0.0184374731f * fTemp17) + (0.0486626849f * fTemp18)) - (0.01763504f * fTemp19)) - (fConst34 * fRec514[1])));
			fRec516[0] = (fRec516[1] + fTemp133);
			fRec514[0] = fRec516[0];
			float fRec515 = fTemp133;
			float fTemp134 = (fConst35 * ((((0.075111717f * fTemp22) + (0.0561372004f * fTemp25)) - (((0.013358606f * fTemp21) + (0.0733252987f * fTemp23)) + (0.000575355429f * fTemp24))) + (fConst3 * (0.0f - ((fConst37 * fRec520[1]) + (fConst36 * fRec517[1]))))));
			...
			fVec27[(IOTA & 255)] = ((0.0283669997f * fTemp7) + (fRec506 + (fRec515 + fRec518)));
			output27[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec27[((IOTA - iConst38) & 255)])));
			float fTemp135 = (fConst39 * ((fConst3 * (0.0f - ((fConst41 * fRec529[1]) + (fConst40 * fRec526[1])))) + (fConst43 * (((((6.50298971e-05f * fTemp8) + (0.000135975395f * fTemp11)) + (0.15302071f * fTemp12)) + (5.58247011e-05f * fTemp10)) - (((3.28118986e-05f * fTemp9) + (8.94775003e-05f * fTemp13)) + (2.82470992e-05f * fTemp14))))));
			...
			float fTemp137 = (fConst45 * ((((9.14677003e-05f * fTemp17) + (0.0403067358f * fTemp18)) - (4.91544997e-05f * fTemp19)) - (fConst46 * fRec532[1])));
			fRec534[0] = (fRec534[1] + fTemp137);
			fRec532[0] = fRec534[0];
			float fRec533 = fTemp137;
			float fTemp138 = (fConst47 * (((((0.000174824396f * fTemp22) + (0.0554972626f * fTemp25)) + (7.25889986e-05f * fTemp24)) - ((4.2903499e-05f * fTemp21) + (0.000105635998f * fTemp23))) + (fConst3 * (0.0f - ((fConst49 * fRec538[1]) + (fConst48 * fRec535[1]))))));
			...
			output28[i] = FAUSTFLOAT((fRec0[0] * ((0.036055848f * fTemp7) + (fRec524 + (fRec533 + fRec536)))));
			float fTemp139 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec547[1]) + (fConst4 * fRec544[1])))) + (fConst7 * ((((((0.0750264823f * fTemp8) + (0.0215810016f * fTemp9)) + (0.0732392594f * fTemp12)) + (0.0197874997f * fTemp10)) + (0.0241451357f * fTemp14)) - ((0.029268872f * fTemp11) + (0.0653505325f * fTemp13))))));
			...
			float fTemp141 = (fConst9 * ((((0.0121151945f * fTemp17) + (0.0279387068f * fTemp19)) - (0.0237230845f * fTemp18)) - (fConst10 * fRec550[1])));
			fRec552[0] = (fRec552[1] + fTemp141);
			fRec550[0] = fRec552[0];
			float fRec551 = fTemp141;
			float fTemp142 = (fConst11 * ((((0.0282184351f * fTemp21) + (0.0257297456f * fTemp24)) - (((0.0102221686f * fTemp22) + (0.0520902947f * fTemp25)) + (0.0215530209f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec556[1]) + (fConst12 * fRec553[1]))))));
			...
			fVec28[(IOTA & 1023)] = ((0.0213273969f * fTemp7) + (fRec542 + (fRec551 + fRec554)));
			output29[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec28[((IOTA - iConst14) & 1023)])));
			float fTemp143 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec565[1]) + (fConst4 * fRec562[1])))) + (fConst7 * ((((((0.00587123213f * fTemp8) + (0.0018423578f * fTemp9)) + (0.0732475966f * fTemp12)) + (0.0296013411f * fTemp10)) + (0.0781914219f * fTemp14)) - ((0.000995533075f * fTemp11) + (0.0716658756f * fTemp13))))));
			...
			float fTemp145 = (fConst9 * ((((0.000379419012f * fTemp17) + (0.0309950802f * fTemp19)) - (0.023767909f * fTemp18)) - (fConst10 * fRec568[1])));
			fRec570[0] = (fRec570[1] + fTemp145);
			fRec568[0] = fRec570[0];
			float fRec569 = fTemp145;
			float fTemp146 = (fConst11 * ((((0.0024089918f * fTemp21) + (0.0384907126f * fTemp24)) - (((0.000384710904f * fTemp22) + (0.0519801863f * fTemp25)) + (0.0231915414f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec574[1]) + (fConst12 * fRec571[1]))))));
			...
			fVec29[(IOTA & 1023)] = ((0.0212396607f * fTemp7) + (fRec560 + (fRec569 + fRec572)));
			output30[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec29[((IOTA - iConst14) & 1023)])));
			float fTemp147 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec583[1]) + (fConst4 * fRec580[1])))) + (fConst7 * (((((0.0272485241f * fTemp11) + (0.0730006322f * fTemp12)) + (0.0217673127f * fTemp10)) + (0.0342091881f * fTemp14)) - (((0.0710336715f * fTemp8) + (0.0196236372f * fTemp9)) + (0.0674240813f * fTemp13))))));
			...
			float fTemp149 = (fConst9 * (((0.0291556548f * fTemp19) - ((0.0112145133f * fTemp17) + (0.023635827f * fTemp18))) - (fConst10 * fRec586[1])));
			fRec588[0] = (fRec588[1] + fTemp149);
			fRec586[0] = fRec588[0];
			float fRec587 = fTemp149;
			float fTemp150 = (fConst11 * ((((0.00957562029f * fTemp22) + (0.0283041019f * fTemp24)) - (((0.0256590657f * fTemp21) + (0.0519150794f * fTemp25)) + (0.0219254922f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec592[1]) + (fConst12 * fRec589[1]))))));
			...
			fVec30[(IOTA & 1023)] = ((0.021263171f * fTemp7) + (fRec578 + (fRec587 + fRec590)));
			output31[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec30[((IOTA - iConst14) & 1023)])));
			float fTemp151 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec601[1]) + (fConst4 * fRec598[1])))) + (fConst7 * ((((0.0504752062f * fTemp11) + (0.0728419647f * fTemp12)) + (0.000905007997f * fTemp10)) - ((((0.0590723641f * fTemp8) + (0.0294377059f * fTemp9)) + (0.0526789501f * fTemp13)) + (0.0528654493f * fTemp14))))));
			...
			float fTemp153 = (fConst9 * (((0.0224124584f * fTemp19) - ((0.0213115346f * fTemp17) + (0.0234476328f * fTemp18))) - (fConst10 * fRec604[1])));
			fRec606[0] = (fRec606[1] + fTemp153);
			fRec604[0] = fRec606[0];
			float fRec605 = fTemp153;
			float fTemp154 = (fConst11 * ((((0.0170818772f * fTemp22) + (0.00117678463f * fTemp24)) - (((0.0384915434f * fTemp21) + (0.0521975644f * fTemp25)) + (0.0176566634f * fTemp23))) + (fConst3 * (0.0f - ((fConst13 * fRec610[1]) + (fConst12 * fRec607[1]))))));
			...
			fVec31[(IOTA & 1023)] = ((0.0215188023f * fTemp7) + (fRec596 + (fRec605 + fRec608)));
			output32[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec31[((IOTA - iConst14) & 1023)])));
			float fTemp155 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec619[1]) + (fConst4 * fRec616[1])))) + (fConst7 * ((((0.0279835369f * fTemp8) + (0.0662282482f * fTemp11)) + (0.072720468f * fTemp12)) - ((((0.0211296622f * fTemp9) + (0.0289013181f * fTemp13)) + (0.0208075456f * fTemp10)) + (0.0735578239f * fTemp14))))));
			...
			float fTemp157 = (fConst9 * (((0.0117636388f * fTemp19) - ((0.0288163405f * fTemp17) + (0.0232578255f * fTemp18))) - (fConst10 * fRec622[1])));
			fRec624[0] = (fRec624[1] + fTemp157);
			fRec622[0] = fRec624[0];
			float fRec623 = fTemp157;
			float fTemp158 = (fConst11 * (((0.0213967245f * fTemp22) - ((((0.0276282839f * fTemp21) + (0.0525623001f * fTemp25)) + (0.0102657415f * fTemp23)) + (0.0270561129f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec628[1]) + (fConst12 * fRec625[1]))))));
			...
			fVec32[(IOTA & 1023)] = ((0.0218233578f * fTemp7) + (fRec614 + (fRec623 + fRec626)));
			output33[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec32[((IOTA - iConst14) & 1023)])));
			float fTemp159 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec637[1]) + (fConst4 * fRec634[1])))) + (fConst7 * (((((0.0790631697f * fTemp8) + (0.000261097506f * fTemp9)) + (0.0723759979f * fTemp11)) + (0.072444655f * fTemp12)) - (((0.000552799087f * fTemp13) + (0.0297821686f * fTemp10)) + (0.000111960799f * fTemp14))))));
			...
			float fTemp161 = (fConst9 * ((0.0f - (((0.0318771005f * fTemp17) + (0.0231040958f * fTemp18)) + (0.000470109895f * fTemp19))) - (fConst10 * fRec640[1])));
			fRec642[0] = (fRec642[1] + fTemp161);
			fRec640[0] = fRec642[0];
			float fRec641 = fTemp161;
			float fTemp162 = (fConst11 * ((((0.000341400388f * fTemp21) + (0.022921443f * fTemp22)) - (((0.0525210612f * fTemp25) + (0.000797109096f * fTemp23)) + (0.0387258418f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec646[1]) + (fConst12 * fRec643[1]))))));
			...
			fVec33[(IOTA & 1023)] = ((0.0218699202f * fTemp7) + (fRec632 + (fRec641 + fRec644)));
			output34[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec33[((IOTA - iConst14) & 1023)])));
			float fTemp163 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec655[1]) + (fConst4 * fRec652[1])))) + (fConst7 * (((((((0.0284455642f * fTemp8) + (0.0215886943f * fTemp9)) + (0.0675874576f * fTemp11)) + (0.0721074194f * fTemp12)) + (0.0280363765f * fTemp13)) + (0.0748034418f * fTemp14)) - (0.0205983743f * fTemp10)))));
			...
			float fTemp165 = (fConst9 * ((0.0f - (((0.0292760506f * fTemp17) + (0.0230583586f * fTemp18)) + (0.0124245109f * fTemp19))) - (fConst10 * fRec658[1])));
			fRec660[0] = (fRec660[1] + fTemp165);
			fRec658[0] = fRec660[0];
			float fRec659 = fTemp165;
			float fTemp166 = (fConst11 * (((((0.0282284953f * fTemp21) + (0.0219505932f * fTemp22)) + (0.00908714812f * fTemp23)) - ((0.0520217717f * fTemp25) + (0.0267841276f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec664[1]) + (fConst12 * fRec661[1]))))));
			...
			fVec34[(IOTA & 1023)] = ((0.0215945859f * fTemp7) + (fRec650 + (fRec659 + fRec662)));
			output35[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec34[((IOTA - iConst14) & 1023)])));
			float fTemp167 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec673[1]) + (fConst4 * fRec670[1])))) + (fConst7 * (((((((0.0289052967f * fTemp9) + (0.0513707697f * fTemp11)) + (0.0720712468f * fTemp12)) + (0.0514557771f * fTemp13)) + (0.00105064665f * fTemp10)) + (0.0528910533f * fTemp14)) - (0.0582734086f * fTemp8)))));
			...
			float fTemp169 = (fConst9 * ((0.0f - (((0.0213611983f * fTemp17) + (0.0231858213f * fTemp18)) + (0.0221319832f * fTemp19))) - (fConst10 * fRec676[1])));
			fRec678[0] = (fRec678[1] + fTemp169);
			fRec676[0] = fRec678[0];
			float fRec677 = fTemp169;
			float fTemp170 = (fConst11 * ((((((0.0377953835f * fTemp21) + (0.0176656134f * fTemp22)) + (0.0170414262f * fTemp23)) + (0.00136615906f * fTemp24)) - (0.0515366904f * fTemp25)) + (fConst3 * (0.0f - ((fConst13 * fRec682[1]) + (fConst12 * fRec679[1]))))));
			...
			fVec35[(IOTA & 1023)] = ((0.0212490987f * fTemp7) + (fRec668 + (fRec677 + fRec680)));
			output36[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec35[((IOTA - iConst14) & 1023)])));
			float fTemp171 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec691[1]) + (fConst4 * fRec688[1])))) + (fConst7 * ((((((0.0189840384f * fTemp9) + (0.0271545351f * fTemp11)) + (0.0723841563f * fTemp12)) + (0.0660079867f * fTemp13)) + (0.0210880898f * fTemp10)) - ((0.0696570203f * fTemp8) + (0.0329198837f * fTemp14))))));
			...
			float fTemp173 = (fConst9 * ((0.0f - (((0.0107511282f * fTemp17) + (0.0233946498f * fTemp18)) + (0.0282803271f * fTemp19))) - (fConst10 * fRec694[1])));
			fRec696[0] = (fRec696[1] + fTemp173);
			fRec694[0] = fRec696[0];
			float fRec695 = fTemp173;
			float fTemp174 = (fConst11 * ((((((0.0248227529f * fTemp21) + (0.00990875531f * fTemp22)) + (0.0216950327f * fTemp23)) + (0.0274209045f * fTemp24)) - (0.0514192879f * fTemp25)) + (fConst3 * (0.0f - ((fConst13 * fRec700[1]) + (fConst12 * fRec697[1]))))));
			...
			fVec36[(IOTA & 1023)] = ((0.0210887678f * fTemp7) + (fRec686 + (fRec695 + fRec698)));
			output37[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec36[((IOTA - iConst14) & 1023)])));
			float fTemp175 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec709[1]) + (fConst4 * fRec706[1])))) + (fConst7 * ((((((0.000242907205f * fTemp8) + (3.53582982e-05f * fTemp11)) + (0.0726197064f * fTemp12)) + (0.0710085332f * fTemp13)) + (0.0290884823f * fTemp10)) - ((0.000359364407f * fTemp9) + (0.0782985613f * fTemp14))))));
			...
			float fTemp177 = (fConst9 * (((0.000140538701f * fTemp17) - ((0.0234908555f * fTemp18) + (0.0304983724f * fTemp19))) - (fConst10 * fRec712[1])));
			fRec714[0] = (fRec714[1] + fTemp177);
			fRec712[0] = fRec714[0];
			float fRec713 = fTemp177;
			float fTemp178 = (fConst11 * (((((0.0001463433f * fTemp22) + (0.0231612809f * fTemp23)) + (0.037823841f * fTemp24)) - ((0.00046989019f * fTemp21) + (0.0514540747f * fTemp25))) + (fConst3 * (0.0f - ((fConst13 * fRec718[1]) + (fConst12 * fRec715[1]))))));
			...
			fVec37[(IOTA & 1023)] = ((0.0210767537f * fTemp7) + (fRec704 + (fRec713 + fRec716)));
			output38[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec37[((IOTA - iConst14) & 1023)])));
			float fTemp179 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec727[1]) + (fConst4 * fRec724[1])))) + (fConst7 * (((((0.0751189515f * fTemp8) + (0.0722680017f * fTemp12)) + (0.0652098954f * fTemp13)) + (0.0201526713f * fTemp10)) - (((0.0206862092f * fTemp9) + (0.0291809756f * fTemp11)) + (0.0264935717f * fTemp14))))));
			...
			float fTemp181 = (fConst9 * (((0.0115857543f * fTemp17) - ((0.0233091302f * fTemp18) + (0.0280655548f * fTemp19))) - (fConst10 * fRec730[1])));
			fRec732[0] = (fRec732[1] + fTemp181);
			fRec730[0] = fRec732[0];
			float fRec731 = fTemp181;
			float fTemp182 = (fConst11 * ((((0.0213378929f * fTemp23) + (0.0262045786f * fTemp24)) - (((0.0270484407f * fTemp21) + (0.0106208129f * fTemp22)) + (0.051189933f * fTemp25))) + (fConst3 * (0.0f - ((fConst13 * fRec736[1]) + (fConst12 * fRec733[1]))))));
			...
			fVec38[(IOTA & 1023)] = ((0.021021558f * fTemp7) + (fRec722 + (fRec731 + fRec734)));
			output39[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec38[((IOTA - iConst14) & 1023)])));
			float fTemp183 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec745[1]) + (fConst4 * fRec742[1])))) + (fConst7 * ((((((0.0548159294f * fTemp8) + (0.0714098513f * fTemp12)) + (0.0497957394f * fTemp13)) + (0.000334952201f * fTemp10)) + (0.0550493822f * fTemp14)) - ((0.0274249651f * fTemp9) + (0.0504837073f * fTemp11))))));
			...
			float fTemp185 = (fConst9 * (((0.0205156226f * fTemp17) - ((0.0229428727f * fTemp18) + (0.0214247312f * fTemp19))) - (fConst10 * fRec748[1])));
			fRec750[0] = (fRec750[1] + fTemp185);
			fRec748[0] = fRec750[0];
			float fRec749 = fTemp185;
			float fTemp186 = (fConst11 * ((((0.0164958239f * fTemp23) + (0.000435539288f * fTemp24)) - (((0.0358597636f * fTemp21) + (0.0177685022f * fTemp22)) + (0.0505891293f * fTemp25))) + (fConst3 * (0.0f - ((fConst13 * fRec754[1]) + (fConst12 * fRec751[1]))))));
			...
			fVec39[(IOTA & 1023)] = ((0.0208466928f * fTemp7) + (fRec740 + (fRec749 + fRec752)));
			output40[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec39[((IOTA - iConst14) & 1023)])));
			float fTemp187 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec763[1]) + (fConst4 * fRec760[1])))) + (fConst7 * ((((0.0706693232f * fTemp12) + (0.026957361f * fTemp13)) + (0.0710781962f * fTemp14)) - ((((0.0282222442f * fTemp8) + (0.019365238f * fTemp9)) + (0.064457871f * fTemp11)) + (0.0194992553f * fTemp10))))));
			...
			float fTemp189 = (fConst9 * (((0.0271662865f * fTemp17) - ((0.0226459559f * fTemp18) + (0.0116593605f * fTemp19))) - (fConst10 * fRec766[1])));
			fRec768[0] = (fRec768[1] + fTemp189);
			fRec766[0] = fRec768[0];
			float fRec767 = fTemp189;
			float fTemp190 = (fConst11 * (((0.0089846272f * fTemp23) - ((((0.025321193f * fTemp21) + (0.0215867851f * fTemp22)) + (0.0500950702f * fTemp25)) + (0.0253549386f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec772[1]) + (fConst12 * fRec769[1]))))));
			...
			fVec40[(IOTA & 1023)] = ((0.0206924342f * fTemp7) + (fRec758 + (fRec767 + fRec770)));
			output41[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec40[((IOTA - iConst14) & 1023)])));
			float fTemp191 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec781[1]) + (fConst4 * fRec778[1])))) + (fConst7 * ((((0.0706604272f * fTemp12) + (0.00135037745f * fTemp13)) + (0.00681092264f * fTemp14)) - ((((0.0776389539f * fTemp8) + (0.00173373055f * fTemp9)) + (0.0700936019f * fTemp11)) + (0.0285186674f * fTemp10))))));
			...
			float fTemp193 = (fConst9 * (((0.0302995667f * fTemp17) - ((0.0226416085f * fTemp18) + (0.000846329611f * fTemp19))) - (fConst10 * fRec784[1])));
			fRec786[0] = (fRec786[1] + fTemp193);
			fRec784[0] = fRec786[0];
			float fRec785 = fTemp193;
			float fTemp194 = (fConst11 * (((0.000230580001f * fTemp23) - ((((0.00226695533f * fTemp21) + (0.0226931982f * fTemp22)) + (0.0501829945f * fTemp25)) + (0.0370829068f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec790[1]) + (fConst12 * fRec787[1]))))));
			...
			fVec41[(IOTA & 1023)] = ((0.0207369793f * fTemp7) + (fRec776 + (fRec785 + fRec788)));
			output42[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec41[((IOTA - iConst14) & 1023)])));
			float fTemp195 = (fConst2 * ((fConst3 * (0.0f - ((fConst5 * fRec799[1]) + (fConst4 * fRec796[1])))) + (fConst7 * (((0.0191032346f * fTemp9) + (0.0715451017f * fTemp12)) - (((((0.0333225541f * fTemp8) + (0.0662550479f * fTemp11)) + (0.0273325257f * fTemp13)) + (0.0211740136f * fTemp10)) + (0.0717903897f * fTemp14))))));
			...
			float fTemp197 = (fConst9 * ((((0.0287366211f * fTemp17) + (0.011244351f * fTemp19)) - (0.0229874998f * fTemp18)) - (fConst10 * fRec802[1])));
			fRec804[0] = (fRec804[1] + fTemp197);
			fRec802[0] = fRec804[0];
			float fRec803 = fTemp197;
			float fTemp198 = (fConst11 * (((0.0249786098f * fTemp21) - ((((0.0214709397f * fTemp22) + (0.0509536341f * fTemp25)) + (0.00961065292f * fTemp23)) + (0.0275326315f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec808[1]) + (fConst12 * fRec805[1]))))));
			...
			fVec42[(IOTA & 1023)] = ((0.0210162718f * fTemp7) + (fRec794 + (fRec803 + fRec806)));
			output43[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec42[((IOTA - iConst14) & 1023)])));
			float fTemp199 = (fConst2 * ((fConst7 * ((((0.050138779f * fTemp8) + (0.0282681696f * fTemp9)) + (0.0725939125f * fTemp12)) - ((((0.0527277216f * fTemp11) + (0.0493723527f * fTemp13)) + (0.00190158573f * fTemp10)) + (0.0611718185f * fTemp14)))) + (fConst3 * (0.0f - ((fConst5 * fRec817[1]) + (fConst4 * fRec814[1]))))));
			...
			float fTemp201 = (fConst9 * ((((0.0224507228f * fTemp17) + (0.0207386706f * fTemp19)) - (0.0234180465f * fTemp18)) - (fConst10 * fRec820[1])));
			fRec822[0] = (fRec822[1] + fTemp201);
			fRec820[0] = fRec822[0];
			float fRec821 = fTemp201;
			float fTemp202 = (fConst11 * (((0.0369623043f * fTemp21) - ((((0.017650567f * fTemp22) + (0.0517398417f * fTemp25)) + (0.0168106556f * fTemp23)) + (0.00247263745f * fTemp24))) + (fConst3 * (0.0f - ((fConst13 * fRec826[1]) + (fConst12 * fRec823[1]))))));
			...
			fVec43[(IOTA & 1023)] = ((0.0212689266f * fTemp7) + (fRec812 + (fRec821 + fRec824)));
