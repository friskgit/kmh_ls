 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp110 = (fConst23 * (((((0.107048161f * fTemp22) + (0.171027735f * fTemp25)) + (0.0676470548f * fTemp24)) - ((0.0623452887f * fTemp21) + (0.272611588f * fTemp23))) + (fConst3 * (0.0f - ((fConst25 * fRec412[1]) + (fConst24 * fRec409[1]))))));
			...
			float fTemp118 = (fConst23 * ((((((0.0631834567f * fTemp21) + (0.277794689f * fTemp22)) + (0.177968666f * fTemp25)) + (0.111204818f * fTemp23)) - (0.0667784438f * fTemp24)) + (fConst3 * (0.0f - ((fConst25 * fRec448[1]) + (fConst24 * fRec445[1]))))));
