 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp10 = (fConst1 * ((((0.0347942263f * fTemp7) + (0.00286360714f * fTemp8)) + (0.0507023819f * fTemp9)) - (fConst3 * fRec1[1])));
			...
			fVec0[(IOTA & 1023)] = (fRec2 + (0.0407193266f * fTemp11));
			output0[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec0[((IOTA - iConst4) & 1023)])));
			float fTemp12 = (fConst1 * ((((0.0140101779f * fTemp7) + (0.00278928876f * fTemp8)) + (0.0599209704f * fTemp9)) - (fConst3 * fRec10[1])));
			fRec12[0] = (fRec12[1] + fTemp12);
			fRec10[0] = fRec12[0];
			float fRec11 = fTemp12;
			fVec1[(IOTA & 1023)] = (fRec11 + (0.0408683084f * fTemp11));
			output1[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec1[((IOTA - iConst4) & 1023)])));
			float fTemp13 = (fConst1 * ((((0.0026898589f * fTemp8) + (0.0605479591f * fTemp9)) - (0.0114021627f * fTemp7)) - (fConst3 * fRec13[1])));
			fRec15[0] = (fRec15[1] + fTemp13);
			fRec13[0] = fRec15[0];
			float fRec14 = fTemp13;
			fVec2[(IOTA & 1023)] = (fRec14 + (0.0410130136f * fTemp11));
			output2[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec2[((IOTA - iConst4) & 1023)])));
			float fTemp14 = (fConst1 * ((((0.00259821489f * fTemp8) + (0.0521559194f * fTemp9)) - (0.032989718f * fTemp7)) - (fConst3 * fRec16[1])));
			fRec18[0] = (fRec18[1] + fTemp14);
			fRec16[0] = fRec18[0];
			float fRec17 = fTemp14;
			fVec3[(IOTA & 1023)] = (fRec17 + (0.041104544f * fTemp11));
			output3[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec3[((IOTA - iConst4) & 1023)])));
			float fTemp15 = (fConst1 * ((((0.00251272391f * fTemp8) + (0.0347163565f * fTemp9)) - (0.0511620231f * fTemp7)) - (fConst3 * fRec19[1])));
			fRec21[0] = (fRec21[1] + fTemp15);
			fRec19[0] = fRec21[0];
			float fRec20 = fTemp15;
			fVec4[(IOTA & 1023)] = (fRec20 + (0.04114509f * fTemp11));
			output4[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec4[((IOTA - iConst4) & 1023)])));
			float fTemp16 = (fConst1 * ((((0.0024580434f * fTemp8) + (0.0127131781f * fTemp9)) - (0.060566064f * fTemp7)) - (fConst3 * fRec22[1])));
			fRec24[0] = (fRec24[1] + fTemp16);
			fRec22[0] = fRec24[0];
			float fRec23 = fTemp16;
			fVec5[(IOTA & 1023)] = (fRec23 + (0.04112041f * fTemp11));
			output5[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec5[((IOTA - iConst4) & 1023)])));
			float fTemp17 = (fConst1 * (((0.00243778317f * fTemp8) - ((0.0606534816f * fTemp7) + (0.0120465606f * fTemp9))) - (fConst3 * fRec25[1])));
			fRec27[0] = (fRec27[1] + fTemp17);
			fRec25[0] = fRec27[0];
			float fRec26 = fTemp17;
			fVec6[(IOTA & 1023)] = (fRec26 + (0.0410337858f * fTemp11));
			output6[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec6[((IOTA - iConst4) & 1023)])));
			float fTemp18 = (fConst1 * (((0.00245792186f * fTemp8) - ((0.0508644097f * fTemp7) + (0.0348676778f * fTemp9))) - (fConst3 * fRec28[1])));
			fRec30[0] = (fRec30[1] + fTemp18);
			fRec28[0] = fRec30[0];
			float fRec29 = fTemp18;
			fVec7[(IOTA & 1023)] = (fRec29 + (0.0408986025f * fTemp11));
			output7[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec7[((IOTA - iConst4) & 1023)])));
			float fTemp19 = (fConst1 * (((0.00251435f * fTemp8) - ((0.0330583751f * fTemp7) + (0.0517679751f * fTemp9))) - (fConst3 * fRec31[1])));
			fRec33[0] = (fRec33[1] + fTemp19);
			fRec31[0] = fRec33[0];
			float fRec32 = fTemp19;
			fVec8[(IOTA & 1023)] = (fRec32 + (0.0407392941f * fTemp11));
			output8[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec8[((IOTA - iConst4) & 1023)])));
			float fTemp20 = (fConst1 * (((0.00259084767f * fTemp8) - ((0.0119160684f * fTemp7) + (0.0600285754f * fTemp9))) - (fConst3 * fRec34[1])));
			fRec36[0] = (fRec36[1] + fTemp20);
			fRec34[0] = fRec36[0];
			float fRec35 = fTemp20;
			fVec9[(IOTA & 1023)] = (fRec35 + (0.0405916721f * fTemp11));
			output9[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec9[((IOTA - iConst4) & 1023)])));
			float fTemp21 = (fConst1 * ((((0.0126381973f * fTemp7) + (0.00268765911f * fTemp8)) - (0.0597162209f * fTemp9)) - (fConst3 * fRec37[1])));
			fRec39[0] = (fRec39[1] + fTemp21);
			fRec37[0] = fRec39[0];
			float fRec38 = fTemp21;
			fVec10[(IOTA & 1023)] = (fRec38 + (0.0404550806f * fTemp11));
			output10[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec10[((IOTA - iConst4) & 1023)])));
			float fTemp22 = (fConst1 * ((((0.0344141237f * fTemp7) + (0.00278081093f * fTemp8)) - (0.0503701456f * fTemp9)) - (fConst3 * fRec40[1])));
			fRec42[0] = (fRec42[1] + fTemp22);
			fRec40[0] = fRec42[0];
			float fRec41 = fTemp22;
			fVec11[(IOTA & 1023)] = (fRec41 + (0.0403658561f * fTemp11));
			output11[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec11[((IOTA - iConst4) & 1023)])));
			float fTemp23 = (fConst1 * ((((0.0508505553f * fTemp7) + (0.00285875192f * fTemp8)) - (0.0338303f * fTemp9)) - (fConst3 * fRec43[1])));
			fRec45[0] = (fRec45[1] + fTemp23);
			fRec43[0] = fRec45[0];
			float fRec44 = fTemp23;
			fVec12[(IOTA & 1023)] = (fRec44 + (0.0403318778f * fTemp11));
			output12[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec12[((IOTA - iConst4) & 1023)])));
			float fTemp24 = (fConst1 * ((((0.0597749613f * fTemp7) + (0.00291049248f * fTemp8)) - (0.0131373238f * fTemp9)) - (fConst3 * fRec46[1])));
			fRec48[0] = (fRec48[1] + fTemp24);
			fRec46[0] = fRec48[0];
			float fRec47 = fTemp24;
			fVec13[(IOTA & 1023)] = (fRec47 + (0.0403546393f * fTemp11));
			output13[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec13[((IOTA - iConst4) & 1023)])));
			float fTemp25 = (fConst1 * ((((0.0603334904f * fTemp7) + (0.00293215131f * fTemp8)) + (0.0110582355f * fTemp9)) - (fConst3 * fRec49[1])));
			fRec51[0] = (fRec51[1] + fTemp25);
			fRec49[0] = fRec51[0];
			float fRec50 = fTemp25;
			fVec14[(IOTA & 1023)] = (fRec50 + (0.0404366329f * fTemp11));
			output14[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec14[((IOTA - iConst4) & 1023)])));
			float fTemp26 = (fConst1 * ((((0.0519110486f * fTemp7) + (0.00291656167f * fTemp8)) + (0.0328533351f * fTemp9)) - (fConst3 * fRec52[1])));
			fRec54[0] = (fRec54[1] + fTemp26);
			fRec52[0] = fRec54[0];
			float fRec53 = fTemp26;
			fVec15[(IOTA & 1023)] = (fRec53 + (0.0405605435f * fTemp11));
			output15[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec15[((IOTA - iConst4) & 1023)])));
			float fTemp27 = (fConst5 * ((((0.0195825603f * fTemp7) + (0.0451132059f * fTemp8)) + (0.0481227823f * fTemp9)) - (fConst6 * fRec55[1])));
			fRec57[0] = (fRec57[1] + fTemp27);
			fRec55[0] = fRec57[0];
			float fRec56 = fTemp27;
			fVec16[(IOTA & 511)] = (fRec56 + (0.0322708413f * fTemp11));
			output16[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec16[((IOTA - iConst7) & 511)])));
			float fTemp28 = (fConst5 * ((((0.0449560694f * fTemp8) + (0.0479146093f * fTemp9)) - (0.02033359f * fTemp7)) - (fConst6 * fRec58[1])));
			fRec60[0] = (fRec60[1] + fTemp28);
			fRec58[0] = fRec60[0];
			float fRec59 = fTemp28;
			fVec17[(IOTA & 511)] = (fRec59 + (0.0324939415f * fTemp11));
			output17[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec17[((IOTA - iConst7) & 511)])));
			float fTemp29 = (fConst5 * ((((0.0448210798f * fTemp8) + (0.018736789f * fTemp9)) - (0.0486914851f * fTemp7)) - (fConst6 * fRec61[1])));
			fRec63[0] = (fRec63[1] + fTemp29);
			fRec61[0] = fRec63[0];
			float fRec62 = fTemp29;
			fVec18[(IOTA & 511)] = (fRec62 + (0.0325503051f * fTemp11));
			output18[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec18[((IOTA - iConst7) & 511)])));
			float fTemp30 = (fConst5 * (((0.0447945148f * fTemp8) - ((0.0470892899f * fTemp7) + (0.0221215151f * fTemp9))) - (fConst6 * fRec64[1])));
			fRec66[0] = (fRec66[1] + fTemp30);
			fRec64[0] = fRec66[0];
			float fRec65 = fTemp30;
			fVec19[(IOTA & 511)] = (fRec65 + (0.0323975682f * fTemp11));
			output19[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec19[((IOTA - iConst7) & 511)])));
			float fTemp31 = (fConst5 * (((0.0448843017f * fTemp8) - ((0.0189559329f * fTemp7) + (0.0480393954f * fTemp9))) - (fConst6 * fRec67[1])));
			fRec69[0] = (fRec69[1] + fTemp31);
			fRec67[0] = fRec69[0];
			float fRec68 = fTemp31;
			fVec20[(IOTA & 511)] = (fRec68 + (0.032148622f * fTemp11));
			output20[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec20[((IOTA - iConst7) & 511)])));
			float fTemp32 = (fConst5 * ((((0.0184437316f * fTemp7) + (0.045031406f * fTemp8)) - (0.0480043404f * fTemp9)) - (fConst6 * fRec70[1])));
			fRec72[0] = (fRec72[1] + fTemp32);
			fRec70[0] = fRec72[0];
			float fRec71 = fTemp32;
			fVec21[(IOTA & 511)] = (fRec71 + (0.0319390222f * fTemp11));
			output21[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec21[((IOTA - iConst7) & 511)])));
			float fTemp33 = (fConst5 * ((((0.0469744243f * fTemp7) + (0.0451650918f * fTemp8)) - (0.0212895516f * fTemp9)) - (fConst6 * fRec73[1])));
			fRec75[0] = (fRec75[1] + fTemp33);
			fRec73[0] = fRec75[0];
			float fRec74 = fTemp33;
			fVec22[(IOTA & 511)] = (fRec74 + (0.031873025f * fTemp11));
			output22[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec22[((IOTA - iConst7) & 511)])));
			float fTemp34 = (fConst5 * ((((0.0480220467f * fTemp7) + (0.0452020504f * fTemp8)) + (0.0195343979f * fTemp9)) - (fConst6 * fRec76[1])));
			fRec78[0] = (fRec78[1] + fTemp34);
			fRec76[0] = fRec78[0];
			float fRec77 = fTemp34;
			fVec23[(IOTA & 511)] = (fRec77 + (0.0320107825f * fTemp11));
			output23[i] = FAUSTFLOAT((0.875537992f * (fRec0[0] * fVec23[((IOTA - iConst7) & 511)])));
			float fTemp35 = (fConst8 * ((((0.0157664623f * fTemp7) + (0.089793995f * fTemp8)) + (0.016095696f * fTemp9)) - (fConst9 * fRec79[1])));
			fRec81[0] = (fRec81[1] + fTemp35);
			fRec79[0] = fRec81[0];
			float fRec80 = fTemp35;
			fVec24[(IOTA & 255)] = (fRec80 + (0.023169281f * fTemp11));
			output24[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec24[((IOTA - iConst10) & 255)])));
			float fTemp36 = (fConst8 * ((((0.0896691233f * fTemp8) + (0.0160665698f * fTemp9)) - (0.0159809142f * fTemp7)) - (fConst9 * fRec82[1])));
			fRec84[0] = (fRec84[1] + fTemp36);
			fRec82[0] = fRec84[0];
			float fRec83 = fTemp36;
			fVec25[(IOTA & 255)] = (fRec83 + (0.0233472046f * fTemp11));
			output25[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec25[((IOTA - iConst10) & 255)])));
			float fTemp37 = (fConst8 * (((0.0896435678f * fTemp8) - ((0.0160100404f * fTemp7) + (0.0155584542f * fTemp9))) - (fConst9 * fRec85[1])));
			fRec87[0] = (fRec87[1] + fTemp37);
			fRec85[0] = fRec87[0];
			float fRec86 = fTemp37;
			fVec26[(IOTA & 255)] = (fRec86 + (0.0232361015f * fTemp11));
			output26[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec26[((IOTA - iConst10) & 255)])));
			float fTemp38 = (fConst8 * ((((0.0157373361f * fTemp7) + (0.0897684395f * fTemp8)) - (0.015529329f * fTemp9)) - (fConst9 * fRec88[1])));
			fRec90[0] = (fRec90[1] + fTemp38);
			fRec88[0] = fRec90[0];
			float fRec89 = fTemp38;
			fVec27[(IOTA & 255)] = (fRec89 + (0.0230581798f * fTemp11));
			output27[i] = FAUSTFLOAT((0.953550935f * (fRec0[0] * fVec27[((IOTA - iConst10) & 255)])));
			float fTemp39 = (fConst11 * ((((0.0977040902f * fTemp8) + (0.000271939003f * fTemp9)) - (0.000105572399f * fTemp7)) - (fConst12 * fRec91[1])));
			fRec93[0] = (fRec93[1] + fTemp39);
			fRec91[0] = fRec93[0];
			float fRec92 = fTemp39;
			output28[i] = FAUSTFLOAT((fRec0[0] * (fRec92 + (0.0215937868f * fTemp11))));
			float fTemp40 = (fConst1 * ((((0.0253808443f * fTemp7) + (0.0576334707f * fTemp9)) - (0.0311001521f * fTemp8)) - (fConst3 * fRec94[1])));
			fRec96[0] = (fRec96[1] + fTemp40);
			fRec94[0] = fRec96[0];
			float fRec95 = fTemp40;
			fVec28[(IOTA & 1023)] = (fRec95 + (0.0476330109f * fTemp11));
			output29[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec28[((IOTA - iConst4) & 1023)])));
			float fTemp41 = (fConst1 * ((((0.00131040148f * fTemp7) + (0.0630399063f * fTemp9)) - (0.0311904605f * fTemp8)) - (fConst3 * fRec97[1])));
			fRec99[0] = (fRec99[1] + fTemp41);
			fRec97[0] = fRec99[0];
			float fRec98 = fTemp41;
			fVec29[(IOTA & 1023)] = (fRec98 + (0.0477870107f * fTemp11));
			output30[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec29[((IOTA - iConst4) & 1023)])));
			float fTemp42 = (fConst1 * (((0.0587538257f * fTemp9) - ((0.0232075527f * fTemp7) + (0.0312903263f * fTemp8))) - (fConst3 * fRec100[1])));
			fRec102[0] = (fRec102[1] + fTemp42);
			fRec100[0] = fRec102[0];
			float fRec101 = fTemp42;
			fVec30[(IOTA & 1023)] = (fRec101 + (0.0479094163f * fTemp11));
			output31[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec30[((IOTA - iConst4) & 1023)])));
			float fTemp43 = (fConst1 * (((0.0454355851f * fTemp9) - ((0.044091858f * fTemp7) + (0.031383168f * fTemp8))) - (fConst3 * fRec103[1])));
			fRec105[0] = (fRec105[1] + fTemp43);
			fRec103[0] = fRec105[0];
			float fRec104 = fTemp43;
			fVec31[(IOTA & 1023)] = (fRec104 + (0.0479796715f * fTemp11));
			output32[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec31[((IOTA - iConst4) & 1023)])));
			float fTemp44 = (fConst1 * (((0.0247445069f * fTemp9) - ((0.0584029667f * fTemp7) + (0.0314560905f * fTemp8))) - (fConst3 * fRec106[1])));
			fRec108[0] = (fRec108[1] + fTemp44);
			fRec106[0] = fRec108[0];
			float fRec107 = fTemp44;
			fVec32[(IOTA & 1023)] = (fRec107 + (0.0479871221f * fTemp11));
			output33[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec32[((IOTA - iConst4) & 1023)])));
			float fTemp45 = (fConst1 * (((0.000323841989f * fTemp9) - ((0.063451007f * fTemp7) + (0.0314955823f * fTemp8))) - (fConst3 * fRec109[1])));
			fRec111[0] = (fRec111[1] + fTemp45);
			fRec109[0] = fRec111[0];
			float fRec110 = fTemp45;
			fVec33[(IOTA & 1023)] = (fRec110 + (0.0479295105f * fTemp11));
			output34[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec33[((IOTA - iConst4) & 1023)])));
			float fTemp46 = (fConst1 * ((0.0f - (((0.0583845675f * fTemp7) + (0.0314956792f * fTemp8)) + (0.0245633107f * fTemp9))) - (fConst3 * fRec112[1])));
			fRec114[0] = (fRec114[1] + fTemp46);
			fRec112[0] = fRec114[0];
			float fRec113 = fTemp46;
			fVec34[(IOTA & 1023)] = (fRec113 + (0.0478135422f * fTemp11));
			output35[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec34[((IOTA - iConst4) & 1023)])));
			float fTemp47 = (fConst1 * ((0.0f - (((0.0439277627f * fTemp7) + (0.0314555205f * fTemp8)) + (0.0453153476f * fTemp9))) - (fConst3 * fRec115[1])));
			fRec117[0] = (fRec117[1] + fTemp47);
			fRec115[0] = fRec117[0];
			float fRec116 = fTemp47;
			fVec35[(IOTA & 1023)] = (fRec116 + (0.0476594605f * fTemp11));
			output36[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec35[((IOTA - iConst4) & 1023)])));
			float fTemp48 = (fConst1 * ((0.0f - (((0.0234751981f * fTemp7) + (0.0313855335f * fTemp8)) + (0.0582970195f * fTemp9))) - (fConst3 * fRec118[1])));
			fRec120[0] = (fRec120[1] + fTemp48);
			fRec118[0] = fRec120[0];
			float fRec119 = fTemp48;
			fVec36[(IOTA & 1023)] = (fRec119 + (0.0474990979f * fTemp11));
			output37[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec36[((IOTA - iConst4) & 1023)])));
			float fTemp49 = (fConst1 * ((0.0f - (((0.000633561984f * fTemp7) + (0.031299185f * fTemp8)) + (0.0626223013f * fTemp9))) - (fConst3 * fRec121[1])));
			fRec123[0] = (fRec123[1] + fTemp49);
			fRec121[0] = fRec123[0];
			float fRec122 = fTemp49;
			fVec37[(IOTA & 1023)] = (fRec122 + (0.0473557934f * fTemp11));
			output38[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec37[((IOTA - iConst4) & 1023)])));
			float fTemp50 = (fConst1 * (((0.0249166898f * fTemp7) - ((0.0311944354f * fTemp8) + (0.0573078096f * fTemp9))) - (fConst3 * fRec124[1])));
			fRec126[0] = (fRec126[1] + fTemp50);
			fRec124[0] = fRec126[0];
			float fRec125 = fTemp50;
			fVec38[(IOTA & 1023)] = (fRec125 + (0.0472312197f * fTemp11));
			output39[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec38[((IOTA - iConst4) & 1023)])));
			float fTemp51 = (fConst1 * (((0.0445543565f * fTemp7) - ((0.0311063584f * fTemp8) + (0.0438187495f * fTemp9))) - (fConst3 * fRec127[1])));
			fRec129[0] = (fRec129[1] + fTemp51);
			fRec127[0] = fRec129[0];
			float fRec128 = fTemp51;
			fVec39[(IOTA & 1023)] = (fRec128 + (0.0471685566f * fTemp11));
			output40[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec39[((IOTA - iConst4) & 1023)])));
			float fTemp52 = (fConst1 * (((0.0577397197f * fTemp7) - ((0.0310386773f * fTemp8) + (0.0241394788f * fTemp9))) - (fConst3 * fRec130[1])));
			fRec132[0] = (fRec132[1] + fTemp52);
			fRec130[0] = fRec132[0];
			float fRec131 = fTemp52;
			fVec40[(IOTA & 1023)] = (fRec131 + (0.0471638553f * fTemp11));
			output41[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec40[((IOTA - iConst4) & 1023)])));
			float fTemp53 = (fConst1 * (((0.0626731813f * fTemp7) - ((0.0310014635f * fTemp8) + (0.0019944529f * fTemp9))) - (fConst3 * fRec133[1])));
			fRec135[0] = (fRec135[1] + fTemp53);
			fRec133[0] = fRec135[0];
			float fRec134 = fTemp53;
			fVec41[(IOTA & 1023)] = (fRec134 + (0.0472141057f * fTemp11));
			output42[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec41[((IOTA - iConst4) & 1023)])));
			float fTemp54 = (fConst1 * ((((0.058352448f * fTemp7) + (0.0232925247f * fTemp9)) - (0.0309981145f * fTemp8)) - (fConst3 * fRec136[1])));
			fRec138[0] = (fRec138[1] + fTemp54);
			fRec136[0] = fRec138[0];
			float fRec137 = fTemp54;
			fVec42[(IOTA & 1023)] = (fRec137 + (0.0473272987f * fTemp11));
			output43[i] = FAUSTFLOAT((0.82675755f * (fRec0[0] * fVec42[((IOTA - iConst4) & 1023)])));
			float fTemp55 = (fConst1 * ((((0.0457676537f * fTemp7) + (0.0431617834f * fTemp9)) - (0.0310316216f * fTemp8)) - (fConst3 * fRec139[1])));
			fRec141[0] = (fRec141[1] + fTemp55);
			fRec139[0] = fRec141[0];
			float fRec140 = fTemp55;
			fVec43[(IOTA & 1023)] = (fRec140 + (0.0474677756f * fTemp11));
